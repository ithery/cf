...
class LazyCollectionTest extends TestCase {
    public function testCanCreateEmptyCollection() {
        $this->assertSame([], CCollection_LazyCollection::make()->all());
        $this->assertSame([], CCollection_LazyCollection::createEmpty()->all());
    }

    public function testCanCreateCollectionFromArray() {
        $array = [1, 2, 3];

        $data = CCollection_LazyCollection::make($array);
    ...
    public function testCanCreateCollectionFromArrayable() {
        ...
        $data = CCollection_LazyCollection::make(CCollection::make($array));
    ...
    public function testCanCreateCollectionFromClosure() {
        $data = CCollection_LazyCollection::make(function () {
            yield 1;
            yield 2;
            yield 3;
        });
    ...
    public function testEager() {
        ...
        $data = CCollection_LazyCollection::make(function () use (&$source) {
            yield from $source;
        })->eager();
    ...
    public function testRemember() {
        ...
        $collection = CCollection_LazyCollection::make(function () use (&$source) {
            yield from $source;
        })->remember();
    ...
    public function testRememberWithDuplicateKeys() {
        $collection = CCollection_LazyCollection::make(function () {
            yield 'key' => 1;
            yield 'key' => 2;
        })->remember();
    ...
    public function testTakeUntilTimeout() {
        ...
        $mock = m::mock(CCollection_LazyCollection::class . '[now]');
        /** @var CCollection_LazyCollection $mock */
        $results = $mock
            ->times(10)
    ...
    public function testTapEach() {
        $data = CCollection_LazyCollection::times(10);
    ...
    public function testUniqueDoubleEnumeration() {
        $data = CCollection_LazyCollection::times(2)->unique();
