...
class ForwardsCallsTest extends TestCase {
    ...
    public function testMissingForwardedCallThrowsCorrectError() {
        ...
        $this->expectExceptionMessage('Call to undefined method ForwardsCallsOne::missingMethod()');
    ...
    public function testMissingAlphanumericForwardedCallThrowsCorrectError() {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Call to undefined method ForwardsCallsOne::this1_shouldWork_too()');
    ...
    public function testNonForwardedErrorIsNotTamperedWith() {
        ...
        $this->expectExceptionMessage('Call to undefined method ForwardsCallsBase::missingMethod()');
    ...
    public function testThrowBadMethodCallException() {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessage('Call to undefined method ForwardsCallsOne::test()');
