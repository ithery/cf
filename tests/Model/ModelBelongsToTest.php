...
class ModelBelongsToTest extends TestCase {
    ...
    public function testBelongsToWithDefault() {
        ...
        $newModel = new ModelBelongsToModelStub();
    ...
    public function testEagerConstraintsAreProperlyAdded() {
        ...
        $models = [new ModelBelongsToModelStub(), new ModelBelongsToModelStub(), new AnotherModelBelongsToModelStub()];
    ...
    public function testIdsInEagerConstraintsCanBeZero() {
        ...
        $models = [new ModelBelongsToModelStub(), new ModelBelongsToModelStubWithZeroId()];
        $relation->addEagerConstraints($models);
    }
    ...
    public function testModelsAreProperlyMatchedToParents() {
        ...
        $model1 = new ModelBelongsToModelStub();
        $model1->foreign_key = 1;
        $model2 = new ModelBelongsToModelStub();
        ...
        $models = $relation->match([$model1, $model2, $model3], new CModel_Collection([$result1, $result2, $result3]), 'foo');
    ...
    public function testDefaultEagerConstraintsWhenIncrementing() {
        ...
        $models = [new MissingModelBelongsToModelStub(), new MissingModelBelongsToModelStub()];
        $relation->addEagerConstraints($models);
    }
    ...
    protected function getRelation($parent = null, $keyType = 'int') {
        ...
        $parent = $parent ?: new ModelBelongsToModelStub();

        return new CModel_Relation_BelongsTo($this->builder, $parent, 'foreign_key', 'id', 'relation');
    }
}
// @codingStandardsIgnoreStart
class ModelBelongsToModelStub extends CModel {
    public $foreign_key = 'foreign.value';
}

class AnotherModelBelongsToModelStub extends CModel {
    public $foreign_key = 'foreign.value.two';
}

class ModelBelongsToModelStubWithZeroId extends CModel {
    public $foreign_key = 0;
}

class MissingModelBelongsToModelStub extends CModel {
    public $foreign_key;
}
