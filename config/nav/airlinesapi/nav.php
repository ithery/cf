...
return array(
    ...
    array(
        ...
        "subnav" => array(
			...
			array(
                "name" => "airlines_useragent",
                "label" => "Airlines User Agent",
                "controller" => "airlines_useragent",
                "method" => "index",
            ),
			array(
                "name" => "airlines_transaction",
                "label" => "Airlines Transaction",
                "controller" => "airlines_transaction",
                "method" => "index",
            ),
        ),
    ),
    array(
        ...
        "subnav" => array(
            array(
                "name" => "blacklist_keyword_report",
                "label" => "Blacklist Keyword",
                "subnav" => array(
                    array(
                        "name" => "blacklist_keyword_log",
                        "label" => "Blacklist Keyword Log",
                        "controller" => "blacklist_keyword_log",
                        "method" => "index",
                        'action' => array(
                            array(
                                'name' => 'download_xls_blacklist_keyword_log',
                                'label' => 'Download XLS',
                                'controller' => 'blacklist_keyword_log',
                                'method' => 'index',
                            ),
