    ...
    <body>
        ...
        <form id="navbar-search" style="display: none;">
          <div class="input-field">
            ...
            <i class="material-icons" id="navbar-search-close">close</i>
          </div>
        </form>
        <div class="container">
          <ul id="navbar-right-menu" class="right ">
            <li id="navbar-search-button"><a href="#"><i class="material-icons">search</i></a></li>
          ...
          <div id="nav-mobile" class="side-nav fixed">
            <div class="menu-container">
              <ul class="menu-list top-menu">
                ...
                <li><a href="/demo/action" class="sidenav-menu"><div class="material-icons nav-icons">home</div><div>HOME</div></a></li>
                ...
                <li><a href="preloader.html"><div class="material-icons nav-icons">shopping_cart</div>STATUS ORDER</a></li>
                <li><a href="preloader.html"><div class="material-icons nav-icons">shopping_cart</div>BANTUAN</a></li>
                <li><a href="preloader.html"><div class="material-icons nav-icons">shopping_cart</div>HUBUNGI KAMI</a></li>
                <li><a href="preloader.html"></li>
              </ul>
            </div>
          </div>
        </div>
