 ...
 *
 * @since Sep 8, 2018, 12:28:15 AM
 */
$favImg = CApp_Default::favImageUrl();
?>
<!DOCTYPE html>
<html class="no-js" lang="en">
    <head>
        <meta charset="utf-8">
        <title>Administrator Disabled</title>
        ...
        <link rel="shortcut icon" href="<?php echo $favImg; ?>">
        ...
        <script src="<?php echo curl::base(); ?>media/js/libs/modernizr.custom.js"></script><div class="main-inner">
    ...
    <body class="gray-bg">
        <div class="middle-box text-center animated fadeInDown">
            <h1>X_X</h1>
            <h3 class="font-bold">Administrator Disabled</h3>
