 ...
 */
trait GuzzleHttp_Ring_Future_BaseFutureTrait {
    ...
    React_Promise_PromiseInterface $promise, callable $wait = null, callable $cancel = null
    ) {
    ...
    public function wait() {
        if (!$this->isRealized) {
            ...
            if (!$this->isRealized) {
                $this->error = new GuzzleHttp_Ring_Exception_RingException('Waiting did not resolve future');
            }
        }
    ...
    public function cancel() {
        if (!$this->isRealized) {
            ...
            $this->error = new GuzzleHttp_Ring_Exception_CancelledFutureAccessException();
            if ($cancelfn) {
                $cancelfn($this);
            }
        }
