 ...
 */
class GuzzleHttp_Ring_Client_CurlHandler {
    ...
    public function __construct(array $options = []) {
        ...
        $this->factory = isset($options['handle_factory']) ? $options['handle_factory'] : new GuzzleHttp_Ring_Client_CurlFactory();
    ...
    public function __invoke(array $request) {
        return new GuzzleHttp_Ring_Future_CompletedFutureArray(
    ...
    public function _invokeAsArray(array $request) {
        ...
        return GuzzleHttp_Ring_Client_CurlFactory::createResponse([$this, '_invokeAsArray'], $request, $response, $hd, $bd);
    }
