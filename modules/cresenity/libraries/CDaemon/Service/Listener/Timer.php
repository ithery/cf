 ...
 */
class CDaemon_Service_Listener_Timer {
    ...
    public static function add($time_interval, $func, $args = array(), $persistent = true) {
        if ($time_interval <= 0) {
            CDaemon_Service_ListenerAbstract::safeEcho(new Exception("bad time_interval"));
            return false;
        }
        if (self::$_event) {
        ...
        if (!is_callable($func)) {
            CDaemon_Service_ListenerAbstract::safeEcho(new Exception("not callable"));
            return false;
        }
            ...
            if ($time_now >= $run_time) {
                foreach ($task_data as $index => $one_task) {
                    ...
                    try {
                        ...
                        CDaemon_Service_ListenerAbstract::safeEcho($e);
                    }
                    if ($persistent) {
