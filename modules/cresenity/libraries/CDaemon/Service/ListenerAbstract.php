 ...
 */
class CDaemon_Service_ListenerAbstract extends CDaemon_ServiceAbstract implements CDaemon_Service_ListenerInterface {
    ...
    protected static function init() {
        ...
        static::initId();
        // Timer init.
        CDaemon_Service_Listener_Timer::init();
    }
...
//        }
    ...
    protected static function monitorWorkersForWindows() {
        Timer::add(1, "\\Workerman\\static::checkWorkerStatusForWindows");
    ...
    protected static function writeStatisticsToStatusFile() {
        ...
        if (static::$_masterPid === posix_getpid()) {
            ...
            file_put_contents(static::$_statisticsFile, "pid\tmemory  " . str_pad('listening', static::$_maxSocketNameLength) . " " . str_pad('worker_name', static::$_maxWorkerNameLength) . " connections " . str_pad('send_fail', 9) . " "
