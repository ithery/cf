...
class CSMTP {
	...
	public function set_html($bool) {
		...
		if($bool) $this->smtp->AltBody    = "To view the message, please use an HTML compatible email viewer!";
	}
	...
	public function set_from($from_email,$from_name="") {
		if(strlen($from_name)==0) $from_name = $from_email;
	...
	public function send() {
		if(!$this->smtp->Send()) throw new Exception($this->smtp->ErrorInfo);
	}
}