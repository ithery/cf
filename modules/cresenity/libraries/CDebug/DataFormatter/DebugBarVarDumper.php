...
class CDebug_DataFormatter_DebugBarVarDumper implements CDebug_DataCollector_AssetProviderInterface {
     ...
     *
     * @return CDebug_DataFormatter_DebugBarVarDumper_DebugBarHtmlDumper
     */
    protected function getDumper() {
        if (!$this->dumper) {
            $this->dumper = new CDebug_DataFormatter_DebugBarVarDumper_DebugBarHtmlDumper();
