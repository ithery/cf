...
*/
final class React_Promise_Promise implements React_Promise_PromiseInterface
{
    private $canceller;
    private $result;
    ...
    private function resolve($value = null)
    {
        ...
        $this->settle(react_promise_resolve($value));
    }
    ...
    private function reject($reason = null)
    {
        ...
        $this->settle(react_promise_reject($reason));
    }

    private function settle(React_Promise_PromiseInterface $result)
    {
        $result = $this->unwrap($result);

        if ($result === $this) {
            $result = new React_Promise_RejectedPromise(
