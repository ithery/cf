 ...
 */
class CElastic_Client_Document extends CElastic_Client_AbstractUpdateAction {

    const OP_TYPE_CREATE = CElastic_Client_Bulk_Action::OP_TYPE_CREATE;
    ...
    public static function create($data) {
        ...
        throw new CElastic_Exception_InvalidException('Failed to create document. Invalid data passed.');
    }
