 ...
 */
class CElastic_Client_Index implements CElastic_Interface_SearchableInterface {
     ...
     */
    public function __construct(CElastic_Client $client, $name) {
        $this->_client = $client;
        if (!is_scalar($name)) {
            throw new CElastic_Exception_InvalidException('Index name should be a scalar type');
        }
     ...
     *
     * @return CElastic_Client_Type Type object
     */
    public function getType($type) {
        return new CElastic_Client_Type($this, $type);
    }

    /**
     * Return Index Stats.
     *
     * @return CElastic_Client_Index_Stats
     */
    public function getStats() {
        return new CElastic_Client_Index_Stats($this);
    }
     ...
     *
     * @return CElastic_Client_Index_Settings Settings object
     */
    public function getSettings() {
        return new CElastic_Client_Index_Settings($this);
    }
    ...
    public function createSearch($query = '', $options = null, BuilderInterface $builder = null) {
        $search = new CElastic_Client_Search($this->getClient(), $builder);
