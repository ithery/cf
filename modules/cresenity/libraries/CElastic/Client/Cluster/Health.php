...
class Health {
    ...
    /**
     * @param CElastic_Client $client The Elastica client.
     */
     ...
     *
     * @return CElastic_Client_Cluster_Health_Index[]
     */
    public function getIndices() {
        $indices = [];
        foreach ($this->_data['indices'] as $indexName => $index) {
            $indices[$indexName] = new CElastic_Client_Cluster_Health_Index($indexName, $index);
        }
        return $indices;
    }
