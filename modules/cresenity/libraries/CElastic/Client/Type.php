 ...
 */
class CElastic_Client_Type implements CElastic_Interface_SearchableInterface {
     ...
     */
    public function __construct(CElastic_Client_Index $index, $name) {
        $this->_index = $index;
        $this->_name = $name;
    }
     ...
     *
     * @param CElastic_Client_Document $doc Document with data
     *
     * @return CElastic_Client_Response
     */
    public function addDocument(CElastic_Client_Document $doc) {
    ...
    /**
     * @param CElastic_Client_Document $document
     *
     * @return CElastic_Client_Response
     */
