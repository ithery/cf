 ...
 */
class CElastic_Client_Query_QueryString extends CElastic_Client_Query_AbstractQuery {
     ...
     *
     * @throws CElastic_Exception_InvalidException If given parameter is not a string
     *
     * @return $this
     */
    public function setQuery($query = '') {
        if (!is_string($query)) {
            throw new CElastic_Exception_InvalidException('Parameter has to be a string');
        }
     ...
     *
     * @throws CElastic_Exception_InvalidException If given parameter is not an array
     *
     * @return $this
     */
    public function setFields(array $fields) {
        if (!is_array($fields)) {
            throw new CElastic_Exception_InvalidException('Parameter has to be an array');
        }
     ...
     *
     * @see CElastic_Clinet_Query_AbstractQuery::toArray()
     *
