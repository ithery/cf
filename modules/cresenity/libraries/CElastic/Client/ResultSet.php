 ...
 */
class CElastic_Client_ResultSet implements \Iterator, \Countable, \ArrayAccess {
     ...
     */
    public function __construct(CElastic_Client_Response $response, CElastic_Client_Query $query, $results) {
        $this->_query = $query;
     ...
     * Returns all results.
     *
     * @return CElastic_Client_Result[] Results
     */
     ...
     *
     * @return array Documents CElastic_Client_Document
     */
     ...
     *
     * @throws CElastic_Exception_InvalidException if an aggregation by the given name cannot be found
     *
     * @return array
     */
    public function getAggregation($name) {
        ...
        throw new CElastic_Exception_InvalidException("This result set does not contain an aggregation named {$name}.");
    }
    ...
    public function getTotalHits() {
        $data = $this->_response->getData();
        return (int) (isset($data['hits']) && isset($data['hits']['total']) ? $data['hits']['total'] : 0);
    }
    ...
    public function getMaxScore() {
        $data = $this->_response->getData();
        return (float) (isset($data['hits']) && isset($data['hits']['max_score']) ? $data['hits']['max_score'] : 0);
    }
    ...
    public function getTotalTime() {
        $data = $this->_response->getData();
        return isset($data['took']) ? $data['took'] : [];
    }
