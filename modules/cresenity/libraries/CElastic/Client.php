...
class CElastic_Client {
    ...
    protected function _initConnections() {
        ...
        $strategy = CElastic_Connection_Strategy_StrategyFactory::create($this->getConfig('connectionStrategy'));
        $this->_connectionPool = new CElastic_Connection_ConnectionPool($connections, $strategy, $this->_callback);
    }
