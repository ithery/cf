 ...
 * @link      http://phpsysinfo.sourceforge.net
 */
require_once dirname(__FILE__)."/../interface/class.PSI_Interface_OS.inc.php";	
require_once dirname(__FILE__)."/../error/class.Error.inc.php";	
require_once dirname(__FILE__)."/../to/class.System.inc.php";	
