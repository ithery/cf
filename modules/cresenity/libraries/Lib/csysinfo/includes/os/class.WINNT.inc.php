 ...
 * @link      http://phpsysinfo.sourceforge.net
 */
require_once dirname(__FILE__).DIRECTORY_SEPARATOR."class.OS.inc.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."to".DIRECTORY_SEPARATOR."device".DIRECTORY_SEPARATOR."class.CpuDevice.inc.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."to".DIRECTORY_SEPARATOR."device".DIRECTORY_SEPARATOR."class.NetDevice.inc.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."to".DIRECTORY_SEPARATOR."device".DIRECTORY_SEPARATOR."class.DiskDevice.inc.php";
require_once dirname(__FILE__).DIRECTORY_SEPARATOR."..".DIRECTORY_SEPARATOR."to".DIRECTORY_SEPARATOR."device".DIRECTORY_SEPARATOR."class.HWDevice.inc.php";
