 ...
 */
class PayPal_Api_CartBase extends PayPal_Common_PayPalModel
{
    /**
    ...
    {
        PayPal_Validation_UrlValidator::validate($notify_url, "NotifyUrl");
    ...
    {
        PayPal_Validation_UrlValidator::validate($order_url, "OrderUrl");
