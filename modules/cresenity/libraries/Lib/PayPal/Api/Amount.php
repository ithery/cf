 ...
 */
class PayPal_Api_Amount extends PayPal_Common_PayPalModel
{
    /**
    ...
    {
        PayPal_Validation_NumericValidator::validate($total, "Total");
        $total = PayPal_Converter_FormatConverter::formatToPrice($total, $this->getCurrency());
        $this->total = $total;
        return $this;
    }
