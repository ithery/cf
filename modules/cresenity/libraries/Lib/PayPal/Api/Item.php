 ...
 */
class PayPal_Api_Item extends PayPal_Common_PayPalModel
{
    /**
    ...
    {
        PayPal_Validation_NumericValidator::validate($price, "Price");
        $price = PayPal_Converter_FormatConverter::formatToPrice($price, $this->getCurrency());
        $this->price = $price;
        return $this;
    }
    ...
    public function setTax($tax)
    {
        ...
        $tax = PayPal_Converter_FormatConverter::formatToPrice($tax, $this->getCurrency());
        $this->tax = $tax;
        return $this;
    }
    ...
    {
        PayPal_Validation_UrlValidator::validate($url, "Url");
        $this->url = $url;
        return $this;
    }
