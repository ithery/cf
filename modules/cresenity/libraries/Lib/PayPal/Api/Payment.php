 ...
 */
class PayPal_Api_Payment extends PayPal_Common_PayPalResourceModel
{
    /**
    ...
    {
        return $this->getLink(PayPal_Core_PayPalConstants::APPROVAL_URL);
    }
    ...
    {
        PayPal_Validation_ArgumentValidator::validate($paymentId, 'paymentId');
        $payLoad = "";
        $json = self::executeCall(
    ...
    public function update($patchRequest, $apiContext = null, $restCall = null)
    {
        ...
        PayPal_Validation_ArgumentValidator::validate($patchRequest, 'patchRequest');
    ...
    {
        PayPal_Validation_ArgumentValidator::validate($this->getId(), "Id");
        PayPal_Validation_ArgumentValidator::validate($paymentExecution, 'paymentExecution');
    ...
    {
        PayPal_Validation_ArgumentValidator::validate($params, 'params');
        $payLoad = "";
        $allowedParams = array(
            'count' => 1,
            'start_id' => 1,
        ...
        $ret = new PayPal_Api_PaymentHistory();
        $ret->fromJson($json);
        return $ret;
    }
