 ...
 */
class PayPal_Core_PayPalHttpConnection
{
     ...
     */
    public function __construct(PayPal_Core_PayPalHttpConfig $httpConfig, array $config)
    {
        if (!function_exists("curl_init")) {
            throw new PayPal_Exception_PayPalConfigurationException("Curl module is not available on this system");
        }
    ...
    public function execute($data)
    {
        ...
        if (curl_errno($ch)) {
            $ex = new PayPal_Exception_PayPalConnectionException(
