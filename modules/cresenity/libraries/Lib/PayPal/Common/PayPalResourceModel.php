 ...
 */
class PayPal_Common_PayPalResourceModel extends PayPal_Common_PayPalModel implements PayPal_Rest_IResource
{
    ...
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('PayPal_Handler_RestHandler'))
    {
        ...
        $restCall = $restCall ? $restCall : new PayPal_Transport_PayPalRestCall($apiContext);
