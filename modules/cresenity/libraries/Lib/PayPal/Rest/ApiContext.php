...
class PayPal_Rest_ApiContext
{
    ...
    public function getCredential()
    {
        if ($this->credential == null) {
            return PayPal_Core_PayPalCredentialManager::getInstance()->getCredentialObject();
        }
    ...
    {
        $result = PayPal_Core_PayPalConfigManager::getInstance()->get('http.headers');
        $headers = array();
    ...
    public function addRequestHeader($name, $value)
    {
        ...
        PayPal_Core_PayPalConfigManager::getInstance()->addConfigs(array($name => $value));
    }
    ...
    {
        PayPal_Core_PayPalConfigManager::getInstance()->addConfigs($config);
    }
    ...
    {
        return PayPal_Core_PayPalConfigManager::getInstance()->getConfigHashmap();
    }
    ...
    {
        return PayPal_Core_PayPalConfigManager::getInstance()->get($searchKey);
    }
