...
class CFormField extends CElement {
    ...
    public function html($indent = 0) {
        ...
        $html->appendln('<div class="control-group' . $group_classes . '" ' . $group_custom_css . $group_attr . '>')->inc_indent();
        if ($this->show_label) {
            $html->appendln('<label id="' . $this->id . '" class="control-label">' . $this->label . '</label>')->br();
        }
