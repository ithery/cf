 ...
 */
class InstagramAPI_Devices_UserAgent {
     ...
     * @return string
     */
    public static function buildUserAgent($appVersion, $userLocale, InstagramAPI_Devices_DeviceInterface $device) {
        ...
        return sprintf(
                self::USER_AGENT_FORMAT, $appVersion, // App version ("10.8.0").
                $device->getAndroidVersion(), $device->getAndroidRelease(), $device->getDPI(), $device->getResolution(), $manufacturerWithBrand, $device->getModel(), $device->getDevice(), $device->getCPU(), $userLocale // Locale ("en_US").
        );
    }
     ...
     * @return string
     */
    protected static function _escapeFbString($string) {
        $result = '';
     ...
     * @return string
     */
    public static function buildFbUserAgent($appName, $appVersion, $versionCode, $userLocale, InstagramAPI_Devices_DeviceInterface $device) {
