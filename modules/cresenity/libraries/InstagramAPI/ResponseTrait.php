 ...
 * won't work properly.
 */
trait InstagramAPI_ResponseTrait {
    ...
    /** @var InstagramAPI_Response_Model_ZMessage[] */
     ...
     *
     * @param InstagramAPI_Response_Model_ZMessage[]|null $_messages
     */
     ...
     */
    public function setHttpResponse(Psr_Http_Message_ResponseInterface $response) {
