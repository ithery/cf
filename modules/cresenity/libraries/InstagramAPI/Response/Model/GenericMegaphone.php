 ...
 * @method InstagramAPI_Response_Model_Button[] getButtons()
 ...
 * @method setButtons(InstagramAPI_Response_Model_Button[] $value)
 ...
 */
class InstagramAPI_Response_Model_GenericMegaphone extends InstagramAPI_AutoPropertyHandler
{
    public $type;
    public $title;
    public $message;
    ...
    public $icon;
    /**
     * @var InstagramAPI_Response_Model_Button[]
     */
    public $buttons;
