 ...
 * @method \InstagramAPI\Response\InstagramAPI_Response_Model_User[] getUsers()
 * @method bool isBigList()
 * @method bool isPageSize()
 * @method bool isUsers()
 * @method setBigList(mixed $value)
 * @method setPageSize(mixed $value)
 * @method setUsers(\InstagramAPI\Response\InstagramAPI_Response_Model_User[] $value)
 */
class BlockedReels extends AutoPropertyHandler
{
    ...
    /**
     * @var \InstagramAPI\Response\InstagramAPI_Response_Model_User[]
     */
    public $users;
    public $page_size;
    public $big_list;
