 ...
 */
class InstagramAPI_Request_Hashtag extends InstagramAPI_Request_RequestCollection {
     ...
     *
     * @return InstagramAPI_Response_TagInfoResponse
     */
    public function getInfo($hashtag) {
        $urlHashtag = urlencode($hashtag); // Necessary for non-English chars.
        return $this->ig->request("tags/{$urlHashtag}/info/")
                        ->getResponse(new InstagramAPI_Response_TagInfoResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_SearchTagResponse
     */
    public function search(
    $query, array $excludeList = []) {
        ...
        return $request->getResponse(new InstagramAPI_Response_SearchTagResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_TagFeedResponse
     */
    public function getFeed($hashtag, $maxId = null) {
        $urlHashtag = urlencode($hashtag); // Necessary for non-English chars.
        ...
        return $hashtagFeed->getResponse(new InstagramAPI_Response_TagFeedResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_TagRelatedResponse
     */
    ...
    $hashtag) {
        ...
        return $this->ig->request("tags/{$urlHashtag}/related/")
                        ...
                        ->getResponse(new InstagramAPI_Response_TagRelatedResponse());
    }
