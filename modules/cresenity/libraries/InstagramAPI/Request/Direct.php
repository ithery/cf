 ...
 */
class InstagramAPI_Request_Direct extends InstagramAPI_Request_RequestCollection {
     ...
     *
     * @return InstagramAPI_Response_DirectInboxResponse
     */
    ...
    $cursorId = null) {
        ...
        return $request->getResponse(new InstagramAPI_Response_DirectInboxResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectVisualInboxResponse
     */
    public function getVisualInbox() {
        return $this->ig->request('direct_v2/visual_inbox/')
                        ->addParam('persistentBadging', 'true')
                        ->getResponse(new InstagramAPI_Response_DirectVisualInboxResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectShareInboxResponse
     */
    public function getShareInbox() {
        return $this->ig->request('direct_share/inbox/?')
                        ->getResponse(new InstagramAPI_Response_DirectShareInboxResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectPendingInboxResponse
     */
    public function getPendingInbox() {
        ...
        return $request->getResponse(new InstagramAPI_Response_DirectPendingInboxResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectRankedRecipientsResponse
     */
    public function getRankedRecipients(
    $mode, $showThreads, $query = null) {
        ...
        return $request
                        ->getResponse(new InstagramAPI_Response_DirectRankedRecipientsResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectRecentRecipientsResponse
     */
    public function getRecentRecipients() {
        return $this->ig->request('direct_share/recent_recipients/')
                        ->getResponse(new InstagramAPI_Response_DirectRecentRecipientsResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectThreadResponse
     */
    public function getThread(
    $threadId, $cursorId = null) {
        ...
        return $request->getResponse(new InstagramAPI_Response_DirectThreadResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectVisualThreadResponse
     */
    ...
    $threadId, $cursorId = null) {
        ...
        return $request->getResponse(new InstagramAPI_Response_DirectVisualThreadResponse());
    }
    ...
    $threadId, $title) {
        return $this->ig->request("direct_v2/threads/{$threadId}/update_title/")
                        ...
                        ->setSignedPost(false)
                        ->getResponse(new InstagramAPI_Response_DirectThreadResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectCreateGroupThreadResponse
     */
    public function createGroupThread(
    array $userIds, $threadTitle) {
        if (count($userIds) < 2) {
        ...
        return $request->getResponse(new InstagramAPI_Response_DirectCreateGroupThreadResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectSendItemResponse
     */
    public function sendText(
    array $recipients, $text, array $options = []) {
        if (!strlen($text)) {
        ...
        if (count($urls)) {
            /** @var InstagramAPI_Response_DirectSendItemResponse $result */
    ...
    array $recipients, $mediaId, array $options = []) {
    ...
    array $recipients, $photoFilename, array $options = []) {
    ...
    array $recipients, $photoFilename, array $externalMetadata = []) {
    ...
    array $recipients, $videoFilename, array $options = []) {
        ...
        $result = $this->ig->internal->configureWithRetries(
                $videoFilename, function () use ($internalMetadata, $recipients, $options) {
    ...
    array $recipients, $videoFilename, array $externalMetadata = []) {
        $internalMetadata = new InternalMetadata();
        $internalMetadata->setDirectRecipients($this->_prepareRecipients($recipients, true));
    ...
    array $recipients, array $options = []) {
    ...
    array $recipients, $hashtag, array $options = []) {
        if (!strlen($hashtag)) {
    ...
    array $recipients, $locationId, array $options = []) {
    ...
    array $recipients, $userId, array $options = []) {
    ...
    $threadId, $threadItemId, $reactionType, array $options = []) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DirectSeenItemResponse
     */
    ...
    $threadId, $threadItemId) {
        return $this->ig->request("direct_v2/threads/{$threadId}/items/{$threadItemId}/seen/")
                        ...
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->setSignedPost(false)
                        ->getResponse(new InstagramAPI_Response_DirectSeenItemResponse());
    }
    ...
    $type, array $recipients, array $options = []) {
        switch ($type) {
            case 'media_share':
        ...
        return $request->setSignedPost(false)
                        ...
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->addPost('_uuid', $this->ig->uuid)
                        ->getResponse(new InstagramAPI_Response_DirectSendItemResponse());
    }
    ...
    $threadId, $threadItemId, $reactionType, $reactionStatus, array $options = []) {
