 ...
 */
class InstagramAPI_Request_Creative extends InstagramAPI_Request_RequestCollection {
    ...
    $stickerType = 'static_stickers', array $location = null) {
        if ($stickerType != 'static_stickers') {
            throw new InvalidArgumentException('You must provide a valid sticker type.');
        }
        if ($location !== null && (!isset($location['lat']) || !isset($location['lng']) || !isset($location['horizontalAccuracy']))) {
        ...
        return $request->getResponse(new InstagramAPI_Response_StickerAssetsResponse());
    }
    ...
    public function getFaceModels() {
        return $this->ig->request('creatives/face_models/')
                        ...
                        ->getResponse(new InstagramAPI_Response_FaceModelsResponse());
    }
    ...
    public function getFaceEffects() {
        return $this->ig->request('creatives/face_effects/')
                        ...
                        ->getResponse(new InstagramAPI_Response_FaceEffectsResponse());
    }
