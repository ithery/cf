 ...
 */
class InstagramAPI_Request_People extends InstagramAPI_Request_RequestCollection {
     ...
     *
     * @return InstagramAPI_Response_UserInfoResponse
     */
    public function getInfoByName($username) {
        return $this->ig->request("users/{$username}/usernameinfo/")->getResponse(new InstagramAPI_Response_UserInfoResponse());
    }
    ...
    public function getInfoById($userId) {
        return $this->ig->request("users/{$userId}/info/")
                        ...
                        ->getResponse(new InstagramAPI_Response_UserInfoResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FollowingRecentActivityResponse
     */
    public function getFollowingRecentActivity($maxId = null) {
        ...
        return $activity->getResponse(new InstagramAPI_Response_FollowingRecentActivityResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_AutoCompleteUserListResponse|null Will be NULL if throttled by Instagram.
     */
    public function getAutoCompleteUserList() {
        try {
            ...
            return $request->getResponse(new InstagramAPI_Response_AutoCompleteUserListResponse());
        } catch (InstagramAPI_Exception_ThrottledException $e) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FriendshipsShowResponse
     */
    public function getFriendship(
    $userId) {
        return $this->ig->request("friendships/show/{$userId}/")->getResponse(new InstagramAPI_Response_FriendshipsShowResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FriendshipsShowManyResponse
     */
    ...
    $userList) {
        ...
        return $this->ig->request('friendships/show_many/')
                        ...
                        ->getResponse(new InstagramAPI_Response_FriendshipsShowManyResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FollowerAndFollowingResponse
     */
    public function getPendingFriendships() {
        $request = $this->ig->request('friendships/pending/');

        return $request->getResponse(new InstagramAPI_Response_FollowerAndFollowingResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FriendshipResponse
     */
    ...
    $userId) {
        return $this->ig->request("friendships/approve/{$userId}/")
                        ...
                        ->getResponse(new InstagramAPI_Response_FriendshipResponse());
    }
    ...
    $userId, $searchQuery = null, $maxId = null) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_SearchUserResponse
     */
    public function search($query) {
        return $this->ig->request('users/search/')
                        ->addParam('ig_sig_key_version', InstagramAPI_Constants::SIG_KEY_VERSION)
                        ->addParam('is_typeahead', true)
                        ->addParam('query', $query)
                        ->addParam('rank_token', $this->ig->rank_token)
                        ->getResponse(new InstagramAPI_Response_SearchUserResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FBSearchResponse
     */
    public function searchFacebook($query) {
        return $this->ig->request('fbsearch/topsearch/')
                        ->addParam('context', 'blended')
                        ->addParam('query', $query)
                        ->addParam('rank_token', $this->ig->rank_token)
                        ->getResponse(new InstagramAPI_Response_FBSearchResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_RecentFacebookSearchesResponse
     */
    public function getRecentFacebookSearches() {
        return $this->ig->request('fbsearch/recent_searches/')
                        ->getResponse(new InstagramAPI_Response_RecentFacebookSearchesResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_LinkAddressBookResponse
     *
    ...
    array $contacts) {
        return $this->ig->request('address_book/link/?include=extra_display_name,thumbnails')
                        ...
                        ->getResponse(new InstagramAPI_Response_LinkAddressBookResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_UnlinkAddressBookResponse
     */
    public function unlinkAddressBook() {
        return $this->ig->request('address_book/unlink/')
                        ...
                        ->addPost('_uid', $this->ig->account_id)
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->getResponse(new InstagramAPI_Response_UnlinkAddressBookResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_DiscoverPeopleResponse
     */
    public function discoverPeople() {
        return $this->ig->request('discover/ayml/')
                        ...
                        ->getResponse(new InstagramAPI_Response_DiscoverPeopleResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_SuggestedUsersResponse
     */
    public function getSuggestedUsers($userId) {
        return $this->ig->request('discover/chaining/')
                        ->addParam('target_id', $userId)
                        ->getResponse(new InstagramAPI_Response_SuggestedUsersResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_SuggestedUsersBadgeResponse
     */
    public function getSuggestedUsersBadge() {
        return $this->ig->request('discover/profile_su_badge/')
                        ...
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->addPost('module', 'discover_people')
                        ->getResponse(new InstagramAPI_Response_SuggestedUsersBadgeResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_SuggestedUsersFacebookResponse
     */
    public function getSuggestedUsersFacebook() {
        return $this->ig->request('fbsearch/suggested_searches/')
                        ->addParam('type', 'blended')
                        ->addParam('rank_token', $this->ig->rank_token)
                        ->getResponse(new InstagramAPI_Response_SuggestedUsersFacebookResponse());
    }
     ...
     * @return InstagramAPI_Response_SuggestedUsersResponse
     */
    public function hideSuggestedUser($userId, $algorithm) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FavoriteResponse
     */
    public function favorite($userId) {
        return $this->ig->request("friendships/favorite/{$userId}/")
                        ...
                        ->addPost('_uid', $this->ig->account_id)
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->getResponse(new InstagramAPI_Response_FavoriteResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_BlockedListResponse
     */
    public function getBlockedList() {
        return $this->ig->request('users/blocked_list/')->getResponse(new InstagramAPI_Response_BlockedListResponse());
    }
     ...
     */
    public function blockMyStory($userId) {
     ...
     */
    public function unblockMyStory($userId) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_BlockedReelsResponse
     */
    public function getBlockedStoryList() {
        return $this->ig->request('friendships/blocked_reels/')
                        ...
                        ->addPost('_uid', $this->ig->account_id)
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->getResponse(new InstagramAPI_Response_BlockedReelsResponse());
    }
     ...
     */
    public function muteFriendStory($userId) {
     ...
     */
    public function unmuteFriendStory($userId) {
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_MutedReelsResponse
     */
    public function getMutedStoryList() {
        return $this->ig->request('friendships/muted_reels/')
                        ...
                        ->addPost('_uid', $this->ig->account_id)
                        ->addPost('_csrftoken', $this->ig->client->getToken())
                        ->getResponse(new InstagramAPI_Response_MutedReelsResponse());
    }
