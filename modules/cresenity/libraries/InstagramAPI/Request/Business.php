 ...
 */
class InstagramAPI_Request_Business extends InstagramAPI_Request_RequestCollection
{
    /**
     * Get insights.
     *
        ...
        $day = null)
    {
        ...
        return $this->ig->request('insights/account_organic_insights/')
            ...
            ->addParam('first', $day)
            ->getResponse(new InstagramAPI_Response_InsightsResponse());
    }
        ...
        $mediaId)
    {
        return $this->ig->request("insights/media_organic_insights/{$mediaId}/")
            ...
            ->getResponse(new InstagramAPI_Response_MediaInsightsResponse());
    }
