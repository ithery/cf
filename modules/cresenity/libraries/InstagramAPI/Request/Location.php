 ...
 */
class InstagramAPI_Request_Location extends InstagramAPI_Request_RequestCollection {
     ...
     *
     * @return InstagramAPI_Response_LocationResponse
     */
    public function search($latitude, $longitude, $query = null) {
        ...
        return $locations->getResponse(new InstagramAPI_Response_LocationResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_FBLocationResponse
     */
    public function searchFacebook($query, $count = null) {
        ...
        return $location->getResponse(new InstagramAPI_Response_FBLocationResponse());
    }
     ...
     * @return InstagramAPI_Response_FBLocationResponse
     */
    public function searchFacebookByPoint($lat, $lng, $count = null) {
        $location = $this->ig->request('fbsearch/places/')
                ->addParam('rank_token', $this->ig->rank_token)
                ->addParam('lat', $lat)
                ->addParam('lng', $lng);
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_RelatedLocationResponse
     */
    public function getRelated($locationId) {
        return $this->ig->request("locations/{$locationId}/related/")
                        ...
                        ->getResponse(new InstagramAPI_Response_RelatedLocationResponse());
    }
     ...
     * @throws InstagramAPI_Exception_InstagramException
     *
     * @return InstagramAPI_Response_LocationFeedResponse
     */
    public function getFeed($locationId, $maxId = null) {
        $locationFeed = $this->ig->request("feed/location/{$locationId}/");
        if ($maxId !== null) {
            $locationFeed->addParam('max_id', $maxId);
        }

        return $locationFeed->getResponse(new InstagramAPI_Response_LocationFeedResponse());
    }
