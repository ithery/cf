 ...
 */
class InstagramAPI_MediaAutoResizer {
    ...
    $inputFile, array $options = []) {
        ...
        if ($minAspectRatio !== null && ($minAspectRatio < $allowedMinRatio || $minAspectRatio > $allowedMaxRatio)) {
            throw new \InvalidArgumentException(sprintf('Minimum aspect ratio must be between %.3f and %.3f.', $allowedMinRatio, $allowedMaxRatio));
        ...
        if ($maxAspectRatio !== null && ($maxAspectRatio < $allowedMinRatio || $maxAspectRatio > $allowedMaxRatio)) {
            throw new \InvalidArgumentException(sprintf('Maximum aspect ratio must be between %.3f and %.3f.', $allowedMinRatio, $allowedMaxRatio));
    ...
    protected function _process() {
        ...
        if ($targetAspectRatio == 1) { // Ratio 1 = Square.
            ...
            $targetWidth = $targetHeight = $this->_operation === self::CROP ? min($targetWidth, $targetHeight) : max($targetWidth, $targetHeight);
        }
        ...
        if ($mustRecalcHeight) {
            ...
            $targetHeight = $useFloorHeightRecalc ? floor($targetWidth / $targetAspectRatio) // >=
