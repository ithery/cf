 ...
 */
class InstagramAPI_Exception_NetworkException extends InstagramAPI_Exception_RequestException {
    ...
    public function __construct(Exception $guzzleException) {
        ...
        $message = 'Network: ' . InstagramAPI_Exception_ServerMessageThrower::prettifyMessage($this->_guzzleException->getMessage());
