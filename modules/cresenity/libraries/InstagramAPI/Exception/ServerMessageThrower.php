 ...
 */
class InstagramAPI_Exception_ServerMessageThrower {
     ...
     */
    public static function autoThrow($prefixString, $serverMessage, InstagramAPI_ResponseInterface $serverResponse = null, Psr_Http_Message_ResponseInterface $httpResponse = null) {
        $messages = [$serverMessage];
        if ($serverResponse instanceof Instagram_ResponseInterface) {
            $fullResponse = $serverResponse->getFullResponse();
            if (isset($fullResponse->error_type) && is_string($fullResponse->error_type)) {
        ...
        $fullClassPath = 'InstagramAPI_Exception_' . $exceptionClass;
        ...
        $e = new $fullClassPath(
                $prefixString !== null ? sprintf('%s: %s', $prefixString, $serverMessage) : $serverMessage
        );
        ...
        if ($serverResponse instanceof InstagramAPI_ResponseInterface && $e instanceof InstagramAPI_Exception_InstagramException) {
