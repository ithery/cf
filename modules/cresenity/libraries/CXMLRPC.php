...
class CXMLRPC {
    ...
    public static function server($services = null, $options = null, $documentor = null) {
        ...
        return new CXMLRPC_Server($services, $options, $documentor);
    }
    ...
    public static function client($url, $options = null, $transport = null) {
        ...
        if (!isset($transport)) {
            $transport = new CXMLRPC_Transport_Stream();
        }
        return new CXMLRPC_Client($url, $options, $transport);
    }
    ...
    public static function documentor($options = null, $docCommentParser = null) {
        if (!$docCommentParser) {
            $docCommentParser = new CXMLRPC_Documentor_Parser_Phpdoc();
        }
        return new CXMLRPC_Documentor($options, $docCommentParser);
    }
    ...
    public static function timestamp($datetime) {
        if (xmlrpc_get_type($datetime) == 'datetime') {
            ...
            throw CXMLRPC_Exception('Variable is not of type datetime', -6);
        }
    }
    ...
    public static function binary($base64) {
        if (xmlrpc_get_type($base64) == 'base64') {
            ...
            throw CXMLRPC_Exception('Variable is not of type base64', -7);
        }
    }
    ...
    public static function encodeCall() {
        ...
        return new CXMLRPC_Client_Call($method, $params);
    }
    ...
    public function bind(&$bound, $call) {
        if (is_a($call, 'CXMLRPC_Client_Call')) {
            $call->bound = & $bound;
        } else {
            $bound = $call;
        }
