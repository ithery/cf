 ...
 * @since Jun 25, 2019, 9:16:06 PM
 * @license Ittron Global Teknologi <ittron.co.id>
 */

/**
 * This class implements the CXMLRPC_Documentor_Parser interface, parsing the docComment
 * as a phpdoc style docComment.
 * @package CXMLRPC
 */
class CXMLRPC_Documentor_Parser_Phpdoc extends CXMLRPC_Documentor_ParserAbstract {
