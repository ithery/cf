 ...
 * @package CXMLRPC
 */
class CXMLRPC_Documentor implements CXMLRPC_DocumentorInterface {
     ...
     */
    public $name = 'CXMLRPC: Simple RPC Server';
    ...
    /**
     * The constructor for the CXMLRPC_Documentor class. 
    ...
    public function handle($rpcServer) {
        ...
        echo 'Powered by <a href="http://ripcord.googlecode.com/">CXMLRPC : Simple RPC Server</a>.';
        echo '</div>';
        echo '</div></body></html>';
    }
            ...
            foreach ($this->methods as $method => $methodData) {
                if (is_array($methodData['call'])) {
                    $reflection = new ReflectionMethod(
                            $methodData['call'][0], $methodData['call'][1]
                    );
                } else {
