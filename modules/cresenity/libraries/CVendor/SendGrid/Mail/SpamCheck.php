 ...
 */
class CVendor_SendGrid_Mail_SpamCheck implements \JsonSerializable {
    /**
    ...
    /**
     * @var An Inbound Parse URL that you would like a copy of your
    ...
    public function setEnable($enable) {
        CVendor_SendGrid_Helper_Assert::boolean($enable, 'enable');
    ...
    public function setThreshold($threshold) {
        CVendor_SendGrid_Helper_Assert::minValue($threshold, 'threshold', 1);
        CVendor_SendGrid_Helper_Assert::maxValue($threshold, 'threshold', 10);
    ...
    public function setPostToUrl($post_to_url) {
        CVendor_SendGrid_Helper_Assert::string($post_to_url, 'post_to_url');
