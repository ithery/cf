 ...
 */
class CVendor_SendGrid_Mail_TrackingSettings implements \JsonSerializable {
    /**
     * @var CVendor_SendGrid_Mail_ClickTracking object
     */
    private $click_tracking;

    /**
     * @var CVendor_SendGrid_Mail_OpenTracking object
     */
    private $open_tracking;

    /**
     * @var CVendor_SendGrid_Mail_SubscriptionTracking object
     */
    private $subscription_tracking;

    /**
     * @var CVendor_SendGrid_Mail_Ganalytics object
     */
    private $ganalytics;
