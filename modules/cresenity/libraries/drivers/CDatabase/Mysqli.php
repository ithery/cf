 ...
 */
class CDatabase_Mysqli_Driver extends CDatabase_Driver {
	...
	public function __construct($config)
	{
		...
		CF::log('debug', 'MySQLi Database Driver Initialized');
	}
...
class CMysqli_Result extends CDatabase_Result {
	...
	public function __construct($link, $object = TRUE, $sql)
	{
		...
		{
			// SQL error
			throw new CDatabase_Exception('database.error', $this->link->error.' - '.$sql);
		}
		else
		{
