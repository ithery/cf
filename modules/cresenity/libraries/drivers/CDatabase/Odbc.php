 ...
 */
class CDatabase_Odbc_Driver extends CDatabase_Driver
{
	/**
	...
	public function __construct($config)
	{
		...
		CF::log('debug', 'ODBC Database Driver Initialized');
	}
...
class COdbc_Result extends CDatabase_Result {
	...
	public function __construct($result, $link, $object = TRUE, $sql)
	{
		...
		elseif (is_bool($result))
		{
			...
			{
				// SQL error
				throw new CDatabase_Exception('database.error', odbc_get_last_message($link).' - '.$sql);
			}
			else
			{
