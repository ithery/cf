 ...
 *
 * @since Jun 19, 2018, 4:59:24 AM
 */
class CGitlab_ApiV3_Repositories extends CGitlab_Api {
    /**
    ...
    public function getFile($project_id, $file_path, $ref) {
        return $this->get($this->getProjectPath($project_id, 'repository/files'), [
            'file_path' => $file_path,
            'ref' => $ref
        ]);
    }
    ...
    public function createFile($project_id, $file_path, $content, $branch_name, $commit_message, $encoding = null) {
        return $this->post($this->getProjectPath($project_id, 'repository/files'), [
            'file_path' => $file_path,
            'branch_name' => $branch_name,
            'content' => $content,
    ...
    public function updateFile($project_id, $file_path, $content, $branch_name, $commit_message, $encoding = null) {
        return $this->put($this->getProjectPath($project_id, 'repository/files'), [
            'file_path' => $file_path,
            'branch_name' => $branch_name,
            'content' => $content,
            'commit_message' => $commit_message,
    ...
    public function deleteFile($project_id, $file_path, $branch_name, $commit_message) {
        return $this->delete($this->getProjectPath($project_id, 'repository/files'), [
            'file_path' => $file_path,
            'branch_name' => $branch_name,
            'commit_message' => $commit_message
        ]);
