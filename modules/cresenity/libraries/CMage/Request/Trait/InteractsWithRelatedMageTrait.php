...
trait CMage_Request_Trait_InteractsWithRelatedMageTrait {
    ...
    public function pivotName() {
        ...
        return ($parent = $this->findParentModel()) ? class_basename($parent->{$this->viaRelationship}()->getPivotClass()) : Resource::DEFAULT_PIVOT_NAME;
    }
