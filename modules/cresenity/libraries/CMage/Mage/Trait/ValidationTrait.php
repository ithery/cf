...
trait CMage_Mage_Trait_ValidationTrait {
    ...
    public function validatorForAdd(CMage_Request $request) {
        return CValidation::factory()->make($request->all(), $this->rulesForAdd($request))
    ...
    public function validatorForEdit(CMage_Request $request) {
        return CValidation::factory()->make($request->all(), $this->rulesForUpdate($request))
            ->after(function ($validator) use ($request) {
                $this->afterValidation($request, $validator);
    ...
    public function validatorForAttachment(CMage_Request $request) {
        return CValidation::factory()->make($request->all(), $this->rulesForAttachment($request));
    }
    ...
    public function validatorForAttachmentUpdate(CMage_Request $request) {
        return CValidation::factory()->make($request->all(), $this->rulesForAttachmentUpdate($request));
    }
    ...
    protected static function formatRules(CMage_Request $request, array $rules) {
        ...
        return c::collect($rules)->map(function ($rules) use ($replacements) {
            return c::collect($rules)->map(function ($rule) use ($replacements) {
