...
class CResources_Manager {
    ...
    public function createS3Driver(array $config) {
        ...
        $options = isset($config['options']) ? $s3Config['root'] : [];
    ...
    protected function getRackspaceContainer(Rackspace $client, array $config) {
        $urlType = isset($config['url_type']) ? $config['url_type'] : null;
    ...
    protected function createCacheStore($config) {
        ...
        return new CCache(
                $this->app['cache']->store($config['store']), isset($config['prefix']) ? $config['prefix'] : 'flysystem', isset($config['expire']) ? $config['expire'] : null
        );
    }
    ...
    protected function adapt(FilesystemInterface $filesystem) {
        return new CResources_Adapter($filesystem);
    }
    ...
    protected function getConfig($name) {
        return CF::config('resource.disks.' . $name);
    }
