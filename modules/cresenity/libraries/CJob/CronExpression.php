...
class CJob_CronExpression {
     ...
     */
    public static function factory($expression, CJob_CronExpression_FieldFactory $fieldFactory = null) {
        $mappings = array(
            '@yearly' => '0 0 1 1 *',
            '@annually' => '0 0 1 1 *',
            '@monthly' => '0 0 1 * *',
        ...
        return new static($expression, $fieldFactory ?: new CJob_CronExpression_FieldFactory());
    }
     ...
     * @param CJob_CronExpression_FieldFactory  $fieldFactory Factory to create cron fields
     */
    public function __construct($expression, CJob_CronExpression_FieldFactory $fieldFactory) {
