<?php
class CTableColumn extends CObject{
	...
	public static function factory($fieldname) {
		return new CTableColumn($fieldname);
	}
	...
	public function render_header_html($export_pdf,$th_class="",$indent=0) {
		...
		switch($this->get_align()) {
			case "left": $data_align.="align-left"; break;
			case "right": $data_align.="align-right"; break;
			case "center": $data_align.="align-center"; break;
		}
		$data_no_line_break = "";
		...
		if($export_pdf) {
			switch($this->get_align()) {
				case "left": $pdf_thead_td_attr.=' align="left"'; break;
				case "right": $pdf_thead_td_attr.=' align="right"'; break;
				case "center": $pdf_thead_td_attr.=' align="center"'; break;
			}
		}
		if($this->sortable) $class.=" sortable";
		if($this->hidden_phone) $class.=" hidden-phone";
