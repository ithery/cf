 ...
 * @since Sep 8, 2018, 4:08:59 AM
 * @license Ittron Global Teknologi <ittron.co.id>
 */
class CApp_Validation_Validator implements CApp_Validation_ValidatorInterface {

    use CApp_Validation_Trait_FormatMessagesTrait,
        CApp_Validation_Trait_ValidatesAttributesTrait;
     ...
     * @return void
     */
    public function __construct(CApp_Translation_Translator $translator,array $data, array $rules, array $messages = [], array $customAttributes = []) {
    ...
    public function passes() {
        $this->messages = new CApp_Message_Bag();
    ...
    protected function validateAttribute($attribute, $rule) {
        ...
        list($rule, $parameters) = CApp_Validation_RuleParser::parse($rule);
    ...
    public function addRules($rules) {
        ...
        $response = (new CApp_Validation_RuleParser($this->data))
                ->explode($rules);
    ...
    public function addExtensions(array $extensions) {
        if ($extensions) {
            $keys = array_map('\Illuminate\Support\cstr::snake', array_keys($extensions));
    ...
    public function addReplacers(array $replacers) {
        if ($replacers) {
            $keys = array_map('\Illuminate\Support\cstr::snake', array_keys($replacers));
