 ...
 * @since Sep 8, 2018, 4:22:54 AM
 * @license Ittron Global Teknologi <ittron.co.id>
 */
class CApp_Validation_RuleParser {
    ...
    protected function prepareRule($rule) {
        ...
        if (!is_object($rule) ||
                $rule instanceof CApp_Validation_Contract_RuleInterface ||
                ($rule instanceof CApp_Validation_Rule_Exists && $rule->queryCallbacks()) ||
                ($rule instanceof CApp_Validation_Rule_Unique && $rule->queryCallbacks())) {
            return $rule;
        }
    ...
    public static function parse($rules) {
        if ($rules instanceof CApp_Validation_RuleRuleContract) {
            return [$rules, []];
        }
