 ...
 * @since Sep 8, 2018, 4:50:24 AM
 * @license Ittron Global Teknologi <ittron.co.id>
 */
class CApp_Translation_Translator extends CApp_Translation_TranslatorBase implements CApp_Translation_TranslatorInterface {
     ...
     *
     * @var CApp_Translation_MessageSelector
     */
    protected $selector;
     ...
     *
     * @param  CApp_Translation_Contract_LoaderInterface  $loader
     * @param  string  $locale
     * @return void
     */
    public function __construct(CApp_Translation_Loader $loader, $locale) {
        $this->loader = $loader;
        $this->locale = $locale;
    }
