...
require_once dirname(__FILE__).DS.'CWebSocketServerUser.php';

abstract class CWebSocketServer {

  protected $userClass = 'CWebSocketServerUser'; // redefine this if you want a custom user class.  The custom user class should inherit from WebSocketUser.
