...
class League_Flysystem_AwsS3v3_AwsS3Adapter extends League_Flysystem_Adapter_AbstractAdapter implements League_Flysystem_Adapter_CanOverwriteFiles
{
     ...
     * @param array    $options
     */
    public function __construct(Aws_S3_S3Client $client, $bucket, $prefix = '', array $options = [])
    {
