...
class User_permission_panel_dashboard_Controller extends CController {
    ...
    public function index() {
        ...
        $app->title(clang::__('User Permission Panel Dashboard'));
        ...
        $form = $app->add_div()->add_class("row-fluid")->add_div()->add_class("span12")->add_widget()->set_title(clang::__('User Permission Panel Dashboard'))->set_icon('user')->add_form('user_filter_form')->set_method('get');
