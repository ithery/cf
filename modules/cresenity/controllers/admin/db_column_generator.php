<?php defined('SYSPATH') OR die('No direct access allowed.');
 class Db_column_generator_Controller extends CController {
	...
	public function index() {
		...
		if($post!=null) {
			if(isset($post['submit'])) {
				...
				if(!is_dir($table_info_path)) mkdir($table_info_path);
				...
				foreach($table_info as $k=>$v) {
					...
					if(!is_dir($column_info_path)) mkdir($column_info_path);
