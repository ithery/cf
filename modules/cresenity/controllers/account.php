...
class Account_Controller extends CController {
    ...
    public function edit_profile() {
        ...
        if ($org != null) {
            ...
            $span->add_field('username-field')->set_label(clang::__("Username"))->add_control('username', 'label')->add_validation(null)->set_value($user->username);
            $span->add_field('first-name-field')->set_label(clang::__("First Name"))->add_control('first_name', 'text')->add_validation(null)->set_value($user->first_name);
            $span->add_field('last-name-field')->set_label(clang::__("Last Name"))->add_control('last_name', 'text')->add_validation(null)->set_value($user->last_name);
            $span = $div->add_div()->add_class('span6');
            $span->add_field('last-login-field')->set_label(clang::__("Last Login"))->add_control('last_login', 'label')->add_validation(null)->set_value($user->last_login);
            $span->add_field('last-request-field')->set_label(clang::__("Last Request"))->add_control('last_request', 'label')->add_validation(null)->set_value($user->last_login);
    ...
    public function profile($user_id = "") {
        ...
        if ($org != null) {
            ...
            $span = $div->add_div()->add_class('span6');
            $span->add_field()->set_label(clang::__("Role"))->add_control('role', 'label')->add_validation(null)->set_value($role->name);
            $span->add_field()->set_label(clang::__("Username"))->add_control('role', 'label')->add_validation(null)->set_value($user->username);
