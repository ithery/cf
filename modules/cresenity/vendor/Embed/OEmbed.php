...
class OEmbed {
    ...
    public function getOembedQueryParameters($url) {
    ...
    private function detectEndpointFromUrl($url) {
    ...
    private static function isXML(UriInterface $uri) {
    ...
    private function extractJSON($json) {
        try {
