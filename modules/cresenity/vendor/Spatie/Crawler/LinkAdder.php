...
class LinkAdder {
    ...
    public function addFromHtml($html, UriInterface $foundOnUrl) {
     ...
     */
    protected function extractLinksFromHtml($html, UriInterface $foundOnUrl) {
    ...
    protected function hasCrawlableScheme(UriInterface $uri) {
        return in_array($uri->getScheme(), ['http', 'https']);
    }

    protected function normalizeUrl(UriInterface $url) {
        return $url->withFragment('');
    }

    protected function shouldCrawl(Node $node) {
