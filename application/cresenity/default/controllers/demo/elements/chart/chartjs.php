...
class Controller_Demo_Elements_Chart_Chartjs extends \Cresenity\Demo\Controller {
    public function index() {
        ...
        $app->addDiv()->addChart()->setChart($lineChart)->addClass('mb-3');
        ...
        $app->addDiv()->addChart()->setChart($barChart)->addClass('mb-3');
        ...
        $app->addDiv()->addChart()->setChart($pieChart)->addClass('mb-3');
