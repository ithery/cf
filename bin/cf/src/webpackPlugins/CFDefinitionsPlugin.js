...
class CFDefinitionsPlugin {
    ...
    constructor(envPath = undefined, additionalEnv = {}) {
        this.envPath = envPath || global.CF.paths.root('.env');
    ...
    static build(additionalEnv) {
        return new CFDefinitionsPlugin(undefined, additionalEnv).plugin;
    }
}

module.exports = CFDefinitionsPlugin;
