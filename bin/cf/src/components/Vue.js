...
class Vue {
    ...
    register(options = {}) {
        if (
            ...
            throw new Error(
                'cf.vue() is a feature flag. Use cf.js(source, destination).vue() instead'
            );
        }

        this.version = new VueVersion(this._cf).detect(options.version);
        ...
        CF.globalStyles = this.options.globalStyles;
        CF.extractingStyles = !!this.options.extractStyles;
    }
    ...
    webpackConfig(webpackConfig) {
        ...
        webpackConfig.module.rules.unshift({
            ...
            use: [
                {
                    loader: this._cf.resolve('vue-loader'),
     ...
     */
    webpackPlugins() {
        let { VueLoaderPlugin } = require(this._cf.resolve('vue-loader'));
