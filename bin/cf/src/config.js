...
module.exports = function (cf) {
    ...
    return {
        ...
        /**
         * Custom Webpack-specific configuration to merge/override CF's.
         *
         * @type {Object}
         */
        webpackConfig: {},
        ...
        /**
         * Custom Babel configuration to be merged with CF's defaults.
         *
         * @type {BabelConfig}
         */
        babelConfig: {},
        ...
        /**
         * Determine if CF should ask the friendly errors plugin to
