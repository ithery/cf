...
function _strtolower($str)
{
	...
	static $CUTF8_upper_to_lower = NULL;

	if ($CUTF8_upper_to_lower === NULL)
	{
		$CUTF8_upper_to_lower = array(
	...
	{
		if (isset($CUTF8_upper_to_lower[$uni[$i]]))
		{
			$uni[$i] = $CUTF8_upper_to_lower[$uni[$i]];
		}
	}
