...
class CCurl_Builder {
    ...
    /**
     * @var array Array with options that are not specific to cURL but are used by the package
     */
     ...
     *
     * @param bool $asArray Indicates whether or not the data should be returned as an array. Default: false
     *
     * @return CCurl_Builder
     */
