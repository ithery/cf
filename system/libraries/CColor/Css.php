...
class CColor_Css {
    ...
    public function setPalette($bgHex = '', $fgHex = '') {
    ...
    public function calcFG($bgHex, $fgHex) {
        ...
        foreach ([1, 0.75, 0.5, 0.25, 0] as $percent) {
    ...
    public function getMinBrightDiff() {
        return $this->minBrightDiff;
    }

    public function setMinBrightDiff($b, $resetPalette = true) {
    ...
    public function getMinColorDiff() {
        return $this->minColorDiff;
    }

    public function setMinColorDiff($d, $resetPalette = true) {
        $this->minColorDiff = $d;
        if ($resetPalette) {
            $this->setPalette($this->bg[0], $this->fg[0]);
        }
    ...
    public function brightness($hex) {
    ...
    public function brightnessDiff($hex1, $hex2) {
        // Returns the brightness value for a color,
        // a number between zero and 178.
        // To allow for maximum readability, the difference between
        // the background brightness and the foreground brightness
    ...
    public function raiseError($message, $method, $line) {
        /*
