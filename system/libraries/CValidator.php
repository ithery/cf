...
class CValidator {
    ...
    /**
     * CValidatorate the domain of an email address by checking if the domain has a
     * valid MX record.
     *
    ...
    public static function credit_card($number, $type = NULL) {
        ...
        if ($type == NULL) {
            ...
            foreach ($type as $t) {
                ...
                if (CValidator::credit_card($number, $t))
                    return TRUE;
            }
        ...
        // CValidatorate the card length by the card type
        ...
        return CValidator::luhn($number);
    }

    /**
     * CValidatorate a number against the [Luhn](http://en.wikipedia.org/wiki/Luhn_algorithm)
     * (mod10) formula.
     *
