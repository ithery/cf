...
class CDebug_DebugBar_GuzzleProfiler implements CDebug_DebugBar_GuzzleProfiler_ProfilerInterface {
    use CDebug_DebugBar_GuzzleProfiler_DescriptionMakerTrait;
