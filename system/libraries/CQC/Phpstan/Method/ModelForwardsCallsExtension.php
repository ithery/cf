...
final class CQC_Phpstan_Method_ModelForwardsCallsExtension implements MethodsClassReflectionExtension {
    /**
    ...
    /**
     * @var CQC_Phpstan_Method_ModelQueryForwardsCallsExtension
     */
