 ...
 *
 * \CModel_Collection|\App\Account[] $accounts
 *
 * and transforms them into:
 *
 * \CModel_Collection<int, \App\Account> $accounts
 *
 * Now IDE's can benefit from auto-completion, and we can benefit from the correct type passed to the generic collection
 */
class CQC_Phpstan_Service_Type_GenericModelCollectionTypeNodeResolverExtension implements TypeNodeResolverExtension {
    /**
    ...
    public function resolve(TypeNode $typeNode, NameScope $nameScope): ?Type {
        ...
        if ($identifierTypeName !== CModel_Collection::class) {
            return null;
        }
