...
class Session_Cookie_Driver implements Session_Driver {
	...
	public function __construct()
	{
		...
		CF::log('debug', 'Session Cookie Driver Initialized');
	}
	...
	public function write($id, $data)
	{
		...
		if (strlen($data) > 4048)
		{
			CF::log('error', 'Session ('.$id.') data exceeds the 4KB limit, ignoring write.');
			return FALSE;
		}

		return cookie::set($this->cookie_name, $data, CF::config('session.expiration'));
	}
