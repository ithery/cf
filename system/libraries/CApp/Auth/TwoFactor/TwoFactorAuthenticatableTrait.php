...
trait CApp_Auth_TwoFactor_TwoFactorAuthenticatableTrait {
    /**
    ...
    public function replaceRecoveryCode($code) {
        $this->forceFill([
            'two_factor_recovery_codes' => c::encrypt(str_replace(
                $code,
                CApp_Auth_RecoveryCode::generate(),
                c::decrypt($this->two_factor_recovery_codes)
            )),
        ])->save();
    }
