 ...
 */
abstract class CApp_React_AbstractReactRenderer {
    /**
     * @var LoggerInterface
     */
    protected $logger;
     ...
     * @return array
     */
    abstract public function render($componentName, $propsString, $uuid, $registeredStores = [], $trace = false);
...
JS;
     ...
     * @return string
     */
    protected function initializeReduxStores($registeredStores = [], $context = []) {
...
JS;
     ...
     * @return string
     */
    protected function wrap($name, $propsString, $uuid, $registeredStores = [], $trace = false) {
...
(function() {
  ...
  return window.cresenity.ReactOnRails.serverRenderReactComponent({
    name: '{$name}',
    domNodeId: '{$uuid}',
    props: props,
    trace: {$traceStr},
...
JS;
    ...
    protected function throwError($consoleReplay, $componentName) {
        ...
        throw new CApp_React_Exception_EvalJsException($componentName, $report);
    }
}
