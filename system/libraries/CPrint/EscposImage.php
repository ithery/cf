...
abstract class CPrint_EscposImage {
     ...
     * @param bool   $allowOptimisations true (default) to use any library-specific tricks
     ...
     *
     * @param bool $doubleDensity true for double density (24px) lines, false for single-density (8px) lines
     *
     ...
     * @param string $filename
     *                                    Filename to load from
     * @param bool   $highDensityVertical
