...
class CDatabase_Schema_MongoDB_Blueprint extends CDatabase_Schema_Blueprint {
    /**
     * The MongoConnection object for this blueprint.
     *
     * @var \CDatabase_Connection_MongoDBConnection
     */
     ...
     *
     * @var \CDatabase_MongoDB_Collection|\MongoDB\Collection
     */
     ...
     *
     * @return CDatabase_Schema_MongoDB_Blueprint
     */
     ...
     * @return CDatabase_Schema_MongoDB_Blueprint
     */
    public function sparseAndUnique($columns = null, $options = []) {
        $columns = $this->fluent($columns);
