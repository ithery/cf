...
class CDatabase_Schema_Exception extends CDatabase_Exception {
    ...
    public static function tableDoesNotExist($tableName) {
        return new self("There is no table with name ':tableName' in the schema.", array(':tableName' => $tableName), self::TABLE_DOESNT_EXIST);
    }
    ...
    public static function indexNameInvalid($indexName) {
        return new self("Invalid index-name :indexName given, has to be [a-zA-Z0-9_]", array(':indexName' => $indexName), self::INDEX_INVALID_NAME);
    }
    ...
    public static function indexDoesNotExist($indexName, $table) {
        return new self("Index 'indexName' does not exist on table ':table'.", array(':indexName' => $indexName, ':table' => $table), self::INDEX_DOESNT_EXIST);
    }
    ...
    public static function indexAlreadyExists($indexName, $table) {
        return new self("An index with name ':indexName' was already defined on table ':table'.", array(':indexName' => $indexName, ':table' => $table), self::INDEX_ALREADY_EXISTS);
    }
    ...
    public static function columnDoesNotExist($columnName, $table) {
        return new self("There is no column with name ':columnName' on table ':table'.", array(':columnName' => $columnName, ':table' => $table), self::COLUMN_DOESNT_EXIST);
    }
    ...
    public static function namespaceAlreadyExists($namespaceName) {
        return new self(
                "The namespace with name ':namespaceName' already exists.", array(':namespaceName' => $namespaceName), self::NAMESPACE_ALREADY_EXISTS
        );
    }
    ...
    public static function tableAlreadyExists($tableName) {
        return new self("The table with name ':tableName' already exists.", array(':tableName' => $tableName), self::TABLE_ALREADY_EXISTS);
    }
    ...
    public static function columnAlreadyExists($tableName, $columnName) {
        return new self(
                "The column ':columnName' on table ':tableName' already exists.", array(':columnName' => $columnName, ':tableName' => $tableName), self::COLUMN_ALREADY_EXISTS
        );
    }
    ...
    public static function sequenceAlreadyExists($sequenceName) {
        return new self("The sequence ':sequenceName' already exists.", array(':sequenceName' => $sequenceName), self::SEQUENCE_ALREADY_EXISTS);
    }
    ...
    public static function sequenceDoesNotExist($sequenceName) {
        return new self("There exists no sequence with the name ':sequenceName'.", array(':sequenceName' => $sequenceName), self::SEQUENCE_DOENST_EXIST);
    }
    ...
    public static function foreignKeyDoesNotExist($fkName, $table) {
        return new self("There exists no foreign key with the name ':fkName' on table ':table'.", array(':fkName' => $fkName, ':table' => $table), self::FOREIGNKEY_DOESNT_EXIST);
    }
