...
class CDatabase_Connector_Pdo_SqlServerConnector extends CDatabase_Connector implements CDatabase_ConnectorInterface {
    /**
    ...
    protected function getDblibDsn(array $config) {
        ...
        ], carr::only($config, ['appname', 'charset', 'version'])));
    }
