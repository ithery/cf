...
interface CDatabase_ResultInterface {
     ...
     * @param null|int   $fetchArgument This argument has a different meaning depending on the value of the $fetchMode parameter:
     ...
     * @param null|array $ctorArgs      Controls how the next row will be returned to the caller.
     *                                  The value must be one of the {@link \Doctrine\DBAL\FetchMode} constants,
     *                                  defaulting to {@link \Doctrine\DBAL\FetchMode::MIXED}.
     *
     * @return array
