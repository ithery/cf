...
class Database_Driver_Pdosqlite extends CDatabase_Driver {
    ...
    public function connect() {
        ...
        try {
            ...
            throw new CDatabase_Exception('There was an SQL error: :error', array(':error' => $e->getMessage()));
        }
    ...
    public function __construct($result, $link, $object = TRUE, $sql) {
        if (is_object($result) OR $result = $link->prepare($sql)) {
            ...
            if (!$result->execute()) {
                ...
                throw new CDatabase_Exception('There was an SQL error: :error', array(':error' => $arr_infos[2]));
            }
            ...
            // SQL error
            throw new CDatabase_Exception('There was an SQL error: :error', array(':error' => $link->errorInfo() . ' - ' . $sql));
        }
