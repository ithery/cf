...
abstract class CDatabase_Seeder {
    /**
    ...
    public function call($class, $silent = false, array $parameters = []) {
        ...
        foreach ($classes as $class) {
            ...
            if ($silent === false && isset($this->command)) {
                c::with(new CConsole_View_Component_TwoColumnDetail($this->command->getOutput()))->render(
                    $name,
     ...
     *
     * @param  \CContainer_ \Container\Container  $container
     *
     * @return $this
     */
     ...
     * @return $this
     */
    public function setCommand(CConsole_Command $command) {
