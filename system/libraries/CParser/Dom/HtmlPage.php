...
class CParser_Dom_HtmlPage {
    ...
    /**
     * @var CParser_Dom_HtmlPageCrawler
     */
    protected $crawler;
    ...
    public function __construct($content = '', $url = '', $charset = 'UTF-8') {
        ...
        $this->crawler = new CParser_Dom_HtmlPageCrawler($this->dom);
    }

    /**
     * Get a CParser_Dom_HtmlPageCrawler object containing the root node of the HTML document.
     *
    ...
    public function getHead() {
        return new CParser_Dom_HtmlPageCrawler($this->getHeadNode());
    }
     ...
     *
     * useful for cleaning up text retrieved by CParser_Dom_HtmlPageCrawler::text() (nodeValue of a DOMNode)
     *
     * @param string $string
     *
     * @return string
    ...
    public static function trimNewlines($string) {
        return CParser_Dom_Helpers::trimNewlines($string);
    }
     ...
     * @throws \Exception
     *
     * @return CParser_Dom_HtmlPage
     */
    public function minify(array $options = []) {
        $pm = new CParser_Dom_PrettyMin($options);
