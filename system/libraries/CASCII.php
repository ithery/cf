...
final class CASCII {
     ...
     */
    public static function charsArray($replace_extra_symbols = false) {
     ...
     */
    public static function charsArrayWithMultiLanguageValues($replace_extra_symbols = false) {
        /**
     ...
     */
    public static function normalizeMsword($str) {
        if ($str === '') {
            return '';
        }
    ...
    public static function normalizeWhitespace(
        $str,
        $keepNonBreakingSpace = false,
        $keepBidiUnicodeControls = false,
        $normalize_control_characters = false
    ) {
        if ($str === '') {
            return '';
        }
    ...
    public static function removeInvisibleCharacters(
        ...
        $url_encoded = false,
        $replacement = '',
        $keep_basic_control_characters = true
    ) {
        // init
        $non_displayables = [];
     ...
     * @param null|bool $replace_single_chars_only [optional]  <p>Single char replacement is better for the
    ...
    public static function toAscii(
        ...
        $replace_single_chars_only = null
    ) {
        if ($str === '') {
            return '';
        }
     ...
     */
    public static function toSlugify(
        $str,
        $separator = '-',
        $language = self::ENGLISH_LANGUAGE_CODE,
        array $replacements = [],
     ...
     *
     * @param string      $str     <p>The input string.</p>
     * @param null|string $unknown [optional] <p>Character use if character unknown. (default is '?')
    ...
    private static function getData($file) {
        ...
        return include DOCROOT . 'system/data/ascii/' . $file . '.php';
    }
    ...
    private static function getDataIfExists($file) {
        $file = DOCROOT . 'system/data/ascii/' . $file . '.php';
