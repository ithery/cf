...
class CApi_OAuth_Middleware_CheckClientCredentials extends CApi_OAuth_Middleware_CheckCredentials {
    /**
    ...
    protected function validateScopes($token, $scopes) {
        ...
        foreach ($scopes as $scope) {
            if ($token->cant($scope)) {
                throw new CApi_OAuth_Exception_MissingScopeException($scope);
            }
        }
    }
}
