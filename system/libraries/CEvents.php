 ...
 * @since Dec 25, 2017, 11:18:05 PM
 * @license Ittron Global Teknologi <ittron.co.id>
 */
class CEvents implements CContracts_Events_Dispatcher {
     ...
     *
     * @param  CContracts_Container|null  $container
     * @return void
     */
    public function __construct(CContracts_Container $container = null) {
        $this->container = $container ?: new CContainer;
    }
    ...
    public function makeListener($listener, $wildcard = false) {
        ...
        return function ($event, $payload) use ($listener, $wildcard) {
            if ($wildcard) {
                ...
                call_user_func_array($listener, array_values($payload));
            }
        };
    }
