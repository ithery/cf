...
class CModel_Scout_Engine_CollectionEngine extends CModel_Scout_EngineAbstract {
    /**
     ...
     */
    protected function searchModels(CModel_Scout_Builder $builder) {
        ...
        return $models->filter(function ($model) use ($builder, $columns) {
            ...
            foreach ($columns as $column) {
                ...
                if (cstr::contains(cstr::lower($attribute), cstr::lower($builder->query))) {
                    return true;
                }
            }
    ...
    public function mapIds($results) {
        ...
        return count($results) > 0
                    ? c::collect($results)->pluck($results[0]->getKeyName())->values()
                    : c::collect();
    }
