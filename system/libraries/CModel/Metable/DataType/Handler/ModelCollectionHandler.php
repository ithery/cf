 ...
 */
class CModel_Metable_DataType_Handler_ModelCollectionHandler implements CModel_Metable_DataType_HandlerInterface {
    /**
     * {@inheritdoc}
     */
    ...
    public function canHandleValue($value) {
        return $value instanceof CModel_Collection;
    }
