...
class CModel_Nested_Query extends CModel_Query {
    ...
    public function getNodeData($id, $required = false) {
        ...
        if (!$data && $required) {
            throw new \CModel_Exception_ModelNotFoundException();
        }
    ...
    public function moveNode($key, $position) {
        ...
        $boundary = [$from, $to];
        $query = $this->toBase()->where(function (CDatabase_Query_Builder $inner) use ($boundary) {
    ...
    public function makeGap($cut, $height) {
        ...
        $query = $this->toBase()->whereNested(function (CDatabase_Query_Builder $inner) use ($cut) {
     ...
     *
     * @param null|CModel_Nested_Trait|CModel $root
     *
    ...
    /**
     * @param CModel_Nested_Trait|CModel $root
     *
     * @return int
     */
     ...
     * @param null|CModel_Nested_Trait|CModel $parent
     *
     * @return int
     */
    ...
    protected function buildRebuildDictionary(
        ...
        foreach ($data as $itemData) {
            /** @var CModel_Nested_Trait|CModel $model */
