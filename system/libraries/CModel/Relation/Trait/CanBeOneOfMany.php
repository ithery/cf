...
trait CModel_Relation_Trait_CanBeOneOfMany {
    /**
     ...
     * @return void
     */
    abstract public function addOneOfManySubQueryConstraints(CModel_Query $query, $column = null, $aggregate = null);
     ...
     * @return void
     */
    abstract public function addOneOfManyJoinSubQueryConstraints(CDatabase_Query_JoinClause $join);

    /**
     * Indicate that the relation is a single result of a larger one-to-many relationship.
     *
     * @param null|string|array    $column
     * @param null|string|\Closure $aggregate
    ...
    protected function newOneOfManySubQuery($groupBy, $column = null, $aggregate = null) {
        ...
        foreach (carr::wrap($groupBy) as $group) {
     ...
     * @param \CModel_Query $subQuery
     * @param string        $on
     *
     * @return void
     */
    protected function addOneOfManyJoinSubQuery(CModel_Query $parent, CModel_Query $subQuery, $on) {
     ...
     * @return void
     */
    protected function mergeOneOfManyJoinsTo(CModel_Query $query) {
    ...
    public function qualifySubSelectColumn($column) {
        return $this->getRelationName() . '.' . c::last(explode('.', $column));
    }
