 ...
 * @template TResult
 *
 * @extends \CModel_Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class CModel_Relation_HasOneOrManyThrough extends CModel_Relation {
     ...
     *
     * @param  \CModel_Query<TRelatedModel>  $query
     ...
     *
     * @param  \CModel_Collection<int, TRelatedModel>  $results
    ...
    protected function buildDictionary(CModel_Collection $results)
    {
        ...
        $isAssociative = carr::isAssoc($results->all());
    ...
    public function firstOrCreate(array $attributes = [], $values = []) {
        ...
        return $this->createOrFirst(array_merge($attributes, c::value($values)));
    }
     ...
     * @return TRelatedModel
     *
     * @throws \CDatabase_Exception_UniqueConstraintViolationException
     */
    public function createOrFirst(array $attributes = [], $values = []) {
        try {
    ...
    public function updateOrCreate(array $attributes, array $values = []) {
        return c::tap($this->firstOrCreate($attributes, $values), function ($instance) use ($values) {
     ...
     * @return TRelatedModel
     *
     * @throws \CModel_Exception_ModelNotFoundException<TRelatedModel>
     */
     ...
     * @param  array  $columns
     * @return \CModel_Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Illuminate\Contracts\Support\Arrayable<array-key, mixed>|array<mixed>) ? \CModel_Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \CModel_Exception_ModelNotFoundException<TRelatedModel>
     */
     ...
     *
     * @return \CCollection_LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @param  array  $columns
     * @return CModel_Query<TRelatedModel>
     */
     ...
     *
     * @param  CModel_Query<TRelatedModel>  $query
     * @param  CModel_Query<TDeclaringModel>  $parentQuery
     * @param  mixed  $columns
     * @return CModel_Query<TRelatedModel>
     */
