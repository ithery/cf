...
class CBot_Command {
    ...
    /**
     * @param array|CBot_Contract_Middleware_MatchingInterface|CBot_Contract_Middleware_HeardInterface $middleware
     *
     * @return $this
     */
    public function middleware($middleware) {
        ...
        $this->middleware = c::collect($middleware)->filter(function ($item) {
            return $item instanceof CBot_Contract_Middleware_MatchingInterface || $item instanceof CBot_Contract_Middleware_HeardInterface;
