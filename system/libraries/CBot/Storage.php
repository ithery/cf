...
class CBot_Storage implements CBot_Contract_StorageInterface {
    /**
     ...
     * Storage constructor.
     *
     * @param CBot_Contract_StorageInterface $driver
     */
    public function __construct(CBot_Contract_StorageInterface $driver) {
        $this->driver = $driver;
    }
