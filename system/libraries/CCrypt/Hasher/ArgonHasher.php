...
class CCrypt_Hasher_ArgonHasher extends CCrypt_HasherAbstract implements CCrypt_HasherInterface {
    /**
    ...
    protected function isUsingValidOptions($hashedValue) {
        ...
        if (!is_int($options['memory_cost'] ?? null)
        ...
        if ($options['memory_cost'] > $this->memory
