...
class CImage_GoogleChart_BarChart extends CImage_GoogleChart_Chart {
     ...
     *
     * @param int    $width     Width of the chart, in pixels. Default value is 200.
     * @param int    $height    Height of the chart, in pixels. Default value is 200.
     * @param string $type      Chooses the type of chart. Use 'g' for grouped chart, 's' for stacked, 'o' for overlapped
     * @param string $direction Chooses the direction of the chart. Use 'v' for vertical, 'h' for horizontal
     */
     ...
     *
     * @param int $barWidth           The width of the bar. You can specify widths and spacing absolutely. Default
     *                                value is 23 pixels, absolute value.
     * @param int $spaceBetweenBars   Space between bars in the same group. This is a width in pixels. Default value is 4 pixels
     *                                for absolute values.
     * @param int $spaceBetweenGroups Space between bar groups in the same group. This is a width in pixels; Default value
     *                                is 8 pixels for absolute values.
     */
    public function setBarWidth($barWidth, $spaceBetweenBars = 4, $spaceBetweenGroups = 8) {
        $this->setProperty('chbh', $this->encodeData([$barWidth, $spaceBetweenBars, $spaceBetweenGroups], ','));
    }
     ...
     *
     * @param string $barScale           You can specify widths and spacing absolutely or relatively, by entering one of the following values:
    ...
    public function setBarScale($barScale = 'a', $spaceBetweenBars = '4', $spaceBetweenGroups = '8') {
        $this->setProperty('chbh', $this->encodeData([$barScale, $spaceBetweenBars, $spaceBetweenGroups], ','));
    }
