...
class CImage_GoogleChart_PieChart extends CImage_GoogleChart_Chart {
     ...
     *
     * @param int  $angle  A floating point value describing how many radians to rotate the chart clockwise.
     *                     One complete turn is 2 pi radiants (2 pi is about 6.2831).
     * @param bool $degree Specifies if $angle is in degrees and not in radians. The function will to the conversion.
     */
