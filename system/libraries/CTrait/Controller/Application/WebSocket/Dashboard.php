...
trait CTrait_Controller_Application_WebSocket_Dashboard {
    ...
    public function dashboard($method = null, ...$args) {
        ...
        c::manager()->registerJs('https://js.pusher.com/7.0/pusher.min.js', CManager_Asset::POS_HEAD);
        c::manager()->registerJs('https://cdn.jsdelivr.net/npm/vue@2.5.17/dist/vue.min.js', CManager_Asset::POS_HEAD);
        c::manager()->registerJs('https://cdn.plot.ly/plotly-latest.min.js', CManager_Asset::POS_HEAD);
        c::manager()->registerJs('https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js', CManager_Asset::POS_HEAD);
        c::manager()->registerJs('https://cdn.jsdelivr.net/npm/v-jsoneditor@1.4.1/dist/v-jsoneditor.min.js', CManager_Asset::POS_HEAD);
