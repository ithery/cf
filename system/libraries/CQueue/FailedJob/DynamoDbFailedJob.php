...
class CQueue_FailedJob_DynamoDbFailedJob extends CQueue_AbstractFailedJob {
    /**
    ...
    public function all() {
        ...
        return c::collect($results['Items'])->sortByDesc(function ($result) {
            ...
            return (object) [
                ...
                'failed_at' => CCarbon::createFromTimestamp(
