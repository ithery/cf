...
class Browser {
    ...
    public function __construct($driver, $resolver = null) {
        ...
        $this->resolver = $resolver ?: new CTesting_Browser_ElementResolver($driver);
    }
    ...
    public function visitRoute($route, $parameters = []) {
        return $this->visit(c::route($route, $parameters));
    }
    ...
    public function with($selector, Closure $callback) {
        $browser = new static(
            $this->driver,
            new CTesting_Browser_ElementResolver($this->driver, $this->resolver->format($selector))
        );
        ...
        if ($selector instanceof CTesting_Browser_Component) {
    ...
    public function elsewhere($selector, Closure $callback) {
        $browser = new static(
            $this->driver,
            new CTesting_Browser_ElementResolver($this->driver, 'body ' . $selector)
        );
