...
trait CTesting_BrowserConcern_MakesAssertions {
    ...
    public function assertTitleContains($title) {
        PHPUnit::assertTrue(
            cstr::contains($this->driver->getTitle(), $title),
    ...
    public function assertSeeIn($selector, $text) {
        ...
        PHPUnit::assertTrue(
            cstr::contains($element->getText(), $text),
    ...
    public function assertScript($expression, $expected = true) {
        $expression = cstr::start($expression, 'return ');
    ...
    public function assertSourceHas($code) {
        ...
        PHPUnit::assertTrue(
            cstr::contains($this->driver->getPageSource(), $code),
...
JS;
    ...
    public function assertSelectHasOptions($field, array $values) {
        ...
        $options = c::collect($options)->unique(function (RemoteWebElement $option) {
    ...
    public function selected($field, $value) {
        ...
        return c::collect($options)->contains(function (RemoteWebElement $option) {
