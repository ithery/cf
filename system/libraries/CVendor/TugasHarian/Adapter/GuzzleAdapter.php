...
class CVendor_TugasHarian_Adapter_GuzzleAdapter implements CVendor_TugasHarian_Contract_AdapterInterface {
    /**
     * @var Client
     */
    protected $client;
     ...
     * @param mixed $e
     *
     * @throws CVendor_TugasHarian_Exception_HttpException
     * @throws CVendor_TugasHarian_Exception_ApiException
     */
    protected function handleError($e) {
        ...
        if ($code != 200) {
            throw new CVendor_TugasHarian_Exception_HttpException(isset($body) ? $body : 'Request not processed.', $code);
        }
        $content = json_decode($body);

        throw new CVendor_TugasHarian_Exception_ApiException(isset($content->message) ? $content->message : 'Request not processed.', $code);
    }
}
