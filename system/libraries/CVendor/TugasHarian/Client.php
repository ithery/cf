...
class CVendor_TugasHarian_Client {
    /**
     * @var CVendor_TugasHarian_Contract_AdapterInterface
     */
    protected $adapter;

    protected $baseUri;

    public function __construct(CVendor_TugasHarian_Contract_AdapterInterface $adapter, $baseUri) {
