...
class CVendor_MailerSend_Helpers_Builder_WebhookParams implements CInterface_Arrayable, \JsonSerializable
{
    private string $url;
    private string $name;
    ...
    /**
     * @param string $url
     * @return CVendor_MailerSend_Helpers_Builder_WebhookParams
     */
    public function setUrl(string $url): CVendor_MailerSend_Helpers_Builder_WebhookParams
    {
        $this->url = $url;
        return $this;
    }
     ...
     */
    public function setName(string $name): CVendor_MailerSend_Helpers_Builder_WebhookParams
    {
        $this->name = $name;
        return $this;
    }
     ...
     * @throws CVendor_MailerSend_Exceptions_MailerSendAssertException
     */
    public function setEvents(array $events): CVendor_MailerSend_Helpers_Builder_WebhookParams
    {
     ...
     * @return CVendor_MailerSend_Helpers_Builder_WebhookParams
     */
    public function setEnabled(?bool $enabled): CVendor_MailerSend_Helpers_Builder_WebhookParams
    {
     ...
     * @return CVendor_MailerSend_Helpers_Builder_WebhookParams
     */
    public function setDomainId(string $domainId): CVendor_MailerSend_Helpers_Builder_WebhookParams
    {
