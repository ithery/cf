...
class CVendor_MailerSend_Helpers_Builder_Inbound implements Arrayable, \JsonSerializable {
    ...
    /**
     * @param null|array|CatchFilter $catchFilter
     *
     * @return $this
     */
    ...
    /**
     * @param null|array|MatchFilter $matchFilter
     *
     * @return $this
     */
    ...
    public function addForward(CVendor_MailerSend_Helpers_Builder_Forward $forward): self {
