...
class CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
{
    ...
    public function setSendPaused(?bool $send_paused): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackClicks(?bool $track_clicks): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackOpens(?bool $track_opens): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackUnsubscribe(?bool $track_unsubscribe): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackContent(?bool $track_content): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackUnsubscribeHtml(?string $track_unsubscribe_html): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setTrackUnsubscribePlain(?string $track_unsubscribe_plain): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setCustomTrackingEnabled(?bool $custom_tracking_enabled): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setCustomTrackingSubdomain(?string $custom_tracking_subdomain): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setPrecedenceBulk(?bool $precedence_bulk): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
    ...
    public function setIgnoreDuplicatedRecipients(?bool $ignore_duplicated_recipients): CVendor_MailerSend_Helpers_Builder_DomainSettingsParams
    {
