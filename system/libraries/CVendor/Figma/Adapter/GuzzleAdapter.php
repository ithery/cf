...
class CVendor_Figma_Adapter_GuzzleAdapter implements CVendor_Figma_Contract_AdapterInterface {
    /**
     * @var Client
     */
    protected $client;
    ...
    public function __construct(array $options = []) {
        ...
        $this->accessToken = carr::get($options, 'accessToken');
        $options = [];
     ...
     * @throws CVendor_Figma_Exception_ApiException
     */
    protected function handleError($e) {
        ...
        if ($code != 200) {
            throw new CVendor_Figma_Exception_HttpException(isset($body) ? $body : 'Request not processed.', $code);
        }
        $content = json_decode($body);

        throw new CVendor_Figma_Exception_ApiException(isset($content->message) ? $content->message : 'Request not processed.', $code);
    }
}
