...
class CVendor_WhatsApp_Client {
    /**
     * @var CVendor_WhatsApp_Contract_AdapterInterface
     */
    protected $adapter;

    protected $baseUri;

    public function __construct(CVendor_WhatsApp_Contract_AdapterInterface $adapter, $baseUri) {
