...
class CVendor_Midtrans_Config {
    ...
    public static function getBaseUrl() {
        return CVendor_Midtrans_Config::$isProduction
        ? CVendor_Midtrans_Config::PRODUCTION_BASE_URL : CVendor_Midtrans_Config::SANDBOX_BASE_URL;
    }
    ...
    public static function getSnapBaseUrl() {
        return CVendor_Midtrans_Config::$isProduction
        ? CVendor_Midtrans_Config::SNAP_PRODUCTION_BASE_URL : CVendor_Midtrans_Config::SNAP_SANDBOX_BASE_URL;
    }
}
