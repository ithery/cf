...
class CServer_Process_FakeInvokedProcess implements CServer_Process_Contract_InvokedProcessInterface {
    /**
     ...
     *
     * @var \CServer_Process_FakeProcessDescription
     */
    protected $process;
     ...
     * @return void
     */
    public function __construct(string $command, CServer_Process_FakeProcessDescription $process) {
