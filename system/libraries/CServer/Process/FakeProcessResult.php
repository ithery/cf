...
class CServer_Process_FakeProcessResult implements CServer_Process_Contract_ProcessResultInterface
{
    /**
     * The command string.
     *
     ...
     * @return void
     */
    public function __construct(string $command = '', int $exitCode = 0, $output = '', $errorOutput = '')
    {
    ...
    {
        return new CServer_Process_FakeProcessResult($command, $this->exitCode, $this->output, $this->errorOutput);
    }
     ...
     * @return bool
     */
    public function seeInOutput($output)
    {
