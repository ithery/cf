...
class CServer_Runner_FFMpeg_Http_DynamicHLSPlaylist implements CInterface_Responsable {
    /**
    ...
    public function __construct() {
        $this->disk = CRunner_FFMpeg_Storage_Disk::make(CF::config('storage.default'));
    }
    ...
    public function open(string $path): self {
        $this->media = CRunner_FFMpeg_Media::make($this->disk, $path);
