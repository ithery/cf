...
class CServer_Runner_FFMpeg_StdListener extends EventEmitter implements ListenerInterface {
    const TYPE_ALL = 'all';
    ...
    public function __construct($eventName = 'listen') {
     ...
     */
    public function get() {
        return new CRunner_FFMpeg_ProcessOutput(
