 ...
 * @method static \CPagination_PaginatorCursorInterface     cursorPaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)      Paginate the given query into a cursor paginator.
