...
class CView_InvokableComponentVariable implements CBase_DeferringDisplayableValueInterface, IteratorAggregate {
    /**
    ...
    public function getIterator() {
        ...
        return new ArrayIterator($result instanceof CInterface_Enumerable ? $result->all() : $result);
    }
