 ...
 */
class CEmail_Event_MessageSent {
    /**
     * The message that was sent.
     *
     * @var \CEmail_SentMessage
     */
    public $sent;
     ...
     * @return void
     */
    public function __construct(CEmail_SentMessage $message, array $data = []) {
        $this->sent = $message;
        $this->data = $data;
    }
    ...
    public function __serialize() {
        $hasAttachments = c::collect($this->message->getAttachments())->isNotEmpty();
