...
use CEmail_Contract_MailQueueInterface as MailQueueContract;

class CEmail_Mailer implements MailerContract, MailQueueContract {
    ...
    public function html($html, $callback) {
        return $this->send(['html' => new CBase_HtmlString($html)], [], $callback);
    }
    ...
    public function send($view, array $data = [], $callback = null) {
        ...
        if ($this->shouldSendMessage($symfonyMessage, $data)) {
            ...
            if ($symfonySentMessage) {
                $sentMessage = new CEmail_SentMessage($symfonySentMessage);
     ...
     * @return null|\CEmail_SentMessage
     */
    protected function sendMailable(CEmail_Contract_MailableInterface $mailable) {
        return $mailable instanceof CQueue_ShouldQueueInterface
    ...
    protected function renderView($view, $data) {
        return $view instanceof CInterface_Htmlable
            ? $view->toHtml()
            : CView_Factory::instance()->make($view, $data)->render();
    }
     ...
     *
     * @param string                             $queue
     * @param \CEmail_Contract_MailableInterface $view
     *
     * @return mixed
     */
    ...
    protected function createMessage() {
        $message = new CEmail_Message(new Email());
     ...
     *
     * @return null|\Symfony\Component\Mailer\SentMessage
     */
     ...
     *
     * @param \CEmail_SentMessage $message
     * @param array               $data
     *
     * @return void
     */
    protected function dispatchSentEvent($message, $data = []) {
        CEvent::dispatcher()->dispatch(
            new CEmail_Event_MessageSent($message, $data)
        );
    }
     ...
     * @return $this
     */
    public function setQueue(CQueue_FactoryInterface $queue) {
        $this->queue = $queue;
