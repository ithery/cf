...
trait CCron_Trait_ManagesFrequenciesTrait {
    /**
    ...
    private function inTimeInterval($startTime, $endTime) {
        list($now, $startTime, $endTime) = [
            CCarbon::now($this->timezone),
            CCarbon::parse($startTime, $this->timezone),
            CCarbon::parse($endTime, $this->timezone),
        ];
    ...
    public function lastDayOfMonth($time = '0:0') {
        ...
        return $this->spliceIntoPosition(3, CCarbon::now()->endOfMonth()->day);
    }
