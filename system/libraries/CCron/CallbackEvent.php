...
class CCron_CallbackEvent extends CCron_Event {
    /**
     ...
     * @return void
     */
    public function __construct(CCron_Contract_EventMutexInterface $mutex, $callback, array $parameters = [], $timezone = null) {
