...
class CConsole_Prompt_Task extends CConsole_Prompt {
     ...
     */
    public function __construct($label = '', $limit = 10, $keepSummary = false, $subLabel = null) {
        $this->label = $label;
        $this->limit = $limit;
    ...
    public function run(Closure $callback) {
        ...
        try {
            ...
            if ($this->pid === 0) {
                ...
                $logger = new CConsole_Prompt_Support_Logger($this->identifier, $this->socket);
            ...
            $this->resetTerminal($originalAsync, false);
     ...
     * @return void
     */
    protected function addLogLines($line) {
     ...
     * @return void
     */
    protected function replacePartialLines($text) {
     ...
     * @return void
     */
    protected function recalculateMaxStableMessages() {
     ...
     * @return void
     */
    protected function resetTerminal($originalAsync, $success = true) {
        $this->finished = true;
    ...
    protected function renderStatically(Closure $callback) {
        ...
        try {
            ...
            $logger = new CConsole_Prompt_Support_Logger($this->identifier);
            $result = $callback($logger);
        } catch (Throwable $e) {
            $this->eraseRenderedLines();
     ...
     * @return void
     */
    protected function printCompletionLine() {
