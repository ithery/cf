...
class CConsole_Prompt_Themes_Default_TaskRenderer extends CConsole_Prompt_Themes_Default_Renderer {
    use CConsole_Prompt_Concerns_HasSpinner;

    /**
     * Render the task.
     *
     * @param CConsole_Prompt_Task $task
     *
     * @return $this
     */
     ...
     * @return string
     */
    protected function stableMessageSymbol($type) {
        if ($type === 'success') {
            return $this->green('✔');
        }
        if ($type === 'error') {
