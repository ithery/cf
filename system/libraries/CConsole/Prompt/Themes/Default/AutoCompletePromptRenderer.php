...
class CConsole_Prompt_Themes_Default_AutoCompletePromptRenderer extends CConsole_Prompt_Themes_Default_Renderer {
    use CConsole_Prompt_Themes_Default_Concerns_DrawsBoxes;

    /**
     * Render the text prompt.
     *
     * @param CConsole_Prompt_AutoCompletePrompt $prompt
     *
     * @return string
     */
