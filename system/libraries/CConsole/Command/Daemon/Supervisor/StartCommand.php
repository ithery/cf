...
class CConsole_Command_Daemon_Supervisor_StartCommand extends CConsole_Command {
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'daemon:supervisor:start
    ...
    public function handle() {
        $factory = new CDaemon_Supervisor_SupervisorFactory();
    ...
    protected function supervisorOptions() {
        ...
        return new CDaemon_Supervisor_SupervisorOptions(
            $this->argument('name'),
