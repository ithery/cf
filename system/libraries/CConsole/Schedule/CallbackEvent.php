...
class CConsole_Schedule_CallbackEvent extends CConsole_Schedule_Event {
    /**
     ...
     * @return void
     */
    public function __construct(CConsole_Schedule_Contract_EventMutexInterface $mutex, $callback, array $parameters = [], $timezone = null) {
        if (!is_string($callback) && !CBase_Reflector::isCallable($callback)) {
