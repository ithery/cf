...
class CConsole_Schedule_Event {
     ...
     *
     * @param \CConsole_Schedule_Contract_EventMutexInterface $mutex
     * @param string                                          $command
     * @param null|\DateTimeZone|string                       $timezone
     *
     * @return void
     */
    public function __construct(CConsole_Schedule_Contract_EventMutexInterface $mutex, $command, $timezone = null) {
        $this->mutex = $mutex;
    ...
    public function buildCommand() {
        return (new CConsole_Schedule_CommandBuilder())->buildCommand($this);
    }
     ...
     * @return $this
     */
    public function preventOverlapsUsing(CConsole_Schedule_Contract_EventMutexInterface $mutex) {
        $this->mutex = $mutex;
