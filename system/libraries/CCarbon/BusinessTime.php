...
class CCarbon_BusinessTime {
     ...
     *
     * @return \Closure<\CCarbon_OpeningHours>
     */
    public function convertOpeningHours() {
         ...
         * a new one from array definition given).
         *
         * @param array|\CCarbon_OpeningHours $defaultOpeningHours opening hours instance or array
         *                                                         definition
         *
         * @throws InvalidArgumentException if $defaultOpeningHours has an invalid type
         *
         * @return \CCarbon_OpeningHours
         */
        return static function ($defaultOpeningHours, $data = null) {
            if ($defaultOpeningHours instanceof CCarbon_OpeningHours) {
            ...
            if (is_array($defaultOpeningHours)) {
                ...
                return CCarbon_OpeningHours::create($hours);
            }
    ...
    public static function enable($carbonClass = null, $defaultOpeningHours = null) {
        ...
        $mixins = [];
        list($region, $holidays, $defaultOpeningHours) = self::getOpeningHoursOptions(
            $defaultOpeningHours,
            $arguments,
     ...
     * @param null|string                $carbonClass
     * @param null|\CCarbon_OpeningHours $openingHours
     * @param null|\DateTimeInterface    $context
     *
     * @return null|\Closure<null|$this>
     */
    public function setOpeningHours($mode = null, $carbonClass = null, $openingHours = null, $context = null) {
        switch ($mode) {
            ...
            default:
                 ...
                 * Set the opening hours for the class/instance.
                 *
                 * @param \CCarbon_OpeningHours|array $openingHours
                 *
                 * @return null|$this
                 */
     ...
     * @param null|mixed $context
     *
     * @return \Closure<\CCarbon_OpeningHours>|\CCarbon_OpeningHours
     */
