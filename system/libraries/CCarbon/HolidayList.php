...
class CCarbon_HolidaysList extends CCarbon_Mixin {
    /**
     * @var array
     */
    public $holidays = [];
    ...
    public function pushToBDList() {
         ...
         *
         * @return null|\Carbon\Carbon|\Carbon\CarbonImmutable|\Carbon\CarbonInterface
         */
    ...
    public function addHolidays() {
         ...
         *
         * @param string        $region
         * @param null|iterable $holidays
         * @param null|iterable $workingDays
         */
