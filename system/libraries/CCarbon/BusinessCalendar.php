...
class CCarbon_BusinessCalendar extends CCarbon_HolidayObserver {
    /**
     * @var null|callable
     */
    ...
    public function setBusinessDayChecker() {
         ...
         *
         * @param null|callable $checkCallback
         *
         * @return null|$this
         */
        return static function ($checkCallback = null) use ($mixin) {
            return CCarbon_BusinessDay_Calculator_MixinConfigPropagator::setBusinessDayChecker(
                $mixin,
