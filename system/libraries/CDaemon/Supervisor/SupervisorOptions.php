...
class CDaemon_Supervisor_SupervisorOptions {
    /**
    ...
    public function __construct(
        ...
        $this->queue = $queue ?: CF::config('queue.connections.' . $connection . '.queue');
    ...
    public function withQueue($queue) {
        return c::tap(clone $this, function ($options) use ($queue) {
            $options->queue = $queue;
        });
    }
    ...
    public function toSupervisorCommand() {
        return CDaemon_Supervisor_SupervisorCommandString::fromOptions($this);
    }
    ...
    public function toWorkerCommand() {
        return CDaemon_Supervisor_WorkerCommandString::fromOptions($this);
    }
    ...
    public static function fromArray(array $array) {
        return c::tap(new static($array['name'], $array['connection']), function ($options) use ($array) {
