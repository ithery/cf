...
abstract class CDaemon_Service_SupervisorService extends CDaemon_ServiceAbstract {
    ...
    public function setup() {
        ...
        $master = (new CDaemon_Supervisor_MasterSupervisor(get_class($this)))->handleOutputUsing(function ($type, $line) {
            CDaemon::log($line);
        });
