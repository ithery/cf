...
class Input {
	...
	{
		// Use XSS clean?
		$this->use_xss_clean = (bool) CF::config('core.global_xss_filtering');
		...
		if (Input::$instance === NULL)
		{
			...
			if (get_magic_quotes_runtime())
			{
				...
				CF::log('debug', 'Disable magic_quotes_runtime! It is evil and deprecated: http://php.net/magic_quotes');
			}
			...
			if (get_magic_quotes_gpc())
			{
				...
				CF::log('debug', 'Disable magic_quotes_gpc! It is evil and deprecated: http://php.net/magic_quotes');
			}
			...
			if (ini_get('register_globals'))
			{
				...
				CF::log('debug', 'Disable register_globals! It is evil and deprecated: http://php.net/register_globals');
			}
			...
			CF::log('debug', 'Global GET, POST and COOKIE data sanitized');
		}
	}
	...
	public function xss_clean($data, $tool = NULL)
	{
		if ($tool === NULL)
		{
			...
			$tool = CF::config('core.global_xss_filtering');
		}
