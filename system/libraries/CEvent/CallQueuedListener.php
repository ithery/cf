...
class CEvent_CallQueuedListener implements CQueue_ShouldQueueInterface {
    use CQueue_Trait_InteractsWithQueue, CQueue_Trait_QueueableTrait;
    ...
    public function failed($e) {
        ...
        $handler = CContainer::getInstance()->make($this->class);
