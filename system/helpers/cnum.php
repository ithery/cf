...
class cnum {
     ...
     * @return string
     */
    public static function ordinal($number, ?string $locale = null) {
        static::ensureIntlExtensionIsInstalled();
     ...
     * @return string
     */
    public static function fileSize($bytes, int $precision = 0, ?int $maxPrecision = null) {
    ...
    public static function withLocale(string $locale, callable $callback) {
        ...
        return c::tap($callback(), fn () => static::useLocale($previousLocale));
    }
