...
class form {
    ...
    public static function open($action = NULL, $attr = array(), $hidden = NULL) {
        ...
        if ($action === NULL) {
            ...
            $action = curl::site(Router::$complete_uri);
        } elseif (strpos($action, '://') === FALSE) {
            // Make the action URI into a URL
            $action = curl::site($action);
        }
    ...
    public static function open_fieldset($data = NULL, $extra = '') {
        return '<fieldset' . chtml::attributes((array) $data) . ' ' . $extra . '>' . "\n";
    }
    ...
    public static function textarea($data, $value = '', $extra = '', $double_encode = TRUE) {
        ...
        return '<textarea' . form::attributes($data, 'textarea') . ' ' . $extra . '>' . chtml::specialchars($value, $double_encode) . '</textarea>';
    }
    ...
    public static function attributes($attr, $type = NULL) {
        ...
        return chtml::attributes(array_merge($sorted, $attr));
    }
