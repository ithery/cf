...
class Factory
{
     ...
     * @var mixed
     */
    private $mapperCache = null;

    /**
     * @var mixed
     */
    private $normalizerCache = null;
    ...
    public function getDebugInfo(): array
    {
        ...
        return [
            ...
            'tokenCacheType' => $this->authTokenCache !== null ? \get_class($this->authTokenCache) : \get_class($this->defaultCache),
            'verifierCacheType' => $this->verifierCache !== null ? \get_class($this->verifierCache) : \get_class($this->defaultCache),
        ];
    }
    ...
    private function getProjectId(): string
    {
        ...
        $serviceAccount = $this->getServiceAccount();
        $projectId ??=  $serviceAccount ? $serviceAccount->projectId : null;
     ...
     */
    private function mapServiceAccount($value): ServiceAccount
    {
