...
final class Messaging implements Contract\Messaging
{
    ...
    public function __construct(
        ...
        AppInstanceApiClient $appInstanceApi,
        MessagingApiExceptionConverter $exceptionConverter
    ) {
     ...
     * @param RegistrationTokens|RegistrationToken|array|string $registrationTokenOrTokens
     * @return array
     */
