...
final class Auth implements Contract\Auth, FederatedUserFetcher
{
    ...
    public function __construct(
        ApiClient $client,
        ?CustomTokenViaGoogleCredentials $tokenGenerator,
    ...
    /**
     * @param Stringable|string $providerId
     * @param Stringable|string $providerUid
     * @return UserRecord
     */
    public function getUserByProviderUid($providerId, $providerUid): UserRecord
    {
