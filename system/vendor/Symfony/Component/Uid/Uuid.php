...
class Uuid extends AbstractUid {
    ...
    public static function fromString($uuid) {
        ...
        $classMap = [
            UuidV1::TYPE => UuidV1::class,
            UuidV3::TYPE => UuidV3::class,
            UuidV4::TYPE => UuidV4::class,
            UuidV5::TYPE => UuidV5::class,
            UuidV6::TYPE => UuidV6::class,
        ];
        $class = isset($classMap[(int) $uuid[14]]) ? $classMap[(int) $uuid[14]] : self::class;
