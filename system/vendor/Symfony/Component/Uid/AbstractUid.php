...
abstract class AbstractUid implements \JsonSerializable {
     ...
     * @return bool
     */
    abstract public static function isValid($uid);
     ...
     */
    abstract public static function fromString($uid);
     ...
     * @throws \InvalidArgumentException When the passed value is not valid
     */
    public static function fromBinary($uid) {
        if (16 !== \strlen($uid)) {
     ...
     * @throws \InvalidArgumentException When the passed value is not valid
     */
    public static function fromBase58($uid) {
        if (22 !== \strlen($uid)) {
     ...
     * @throws \InvalidArgumentException When the passed value is not valid
     */
    public static function fromBase32($uid) {
        if (26 !== \strlen($uid)) {
     ...
     * @return static
     */
    public static function fromRfc4122($uid) {
        if (36 !== \strlen($uid)) {
    ...
    private function spaceshipOperator($a, $b) {
        if ($a == $b) {
            return 0;
        }
    ...
    public function compare(self $other) {
        return (\strlen($this->uid) - \strlen($other->uid)) ?: $this->spaceshipOperator($this->uid, $other->uid);
    }
