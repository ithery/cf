...
class CollectionConfigurator {
    ...
    public function __construct(RouteCollection $parent, $name, CollectionConfigurator $parentConfigurator = null, array $parentPrefixes = null) {
        $this->parent = $parent;
        $this->name = $name;
    ...
    private function createRoute($path) {
        $clonedRoute = clone $this->route;
        return $clonedRoute->setPath($path);
    }
