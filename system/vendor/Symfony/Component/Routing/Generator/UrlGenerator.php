...
class UrlGenerator implements UrlGeneratorInterface, ConfigurableRequirementsInterface {
    ...
    private static $QUERY_FRAGMENT_DECODED = [
    ...
    public function generate($name, $parameters = [], $referenceType = self::ABSOLUTE_PATH) {
        $route = null;
        $locale = isset($parameters['_locale']) ? $parameters['_locale'] : $this->context->getParameter('_locale') != null ? $this->context->getParameter('_locale') : $this->defaultLocale;
        ...
        if (null === $route = $route !== null ? $route : $this->routes->get($name)) {
