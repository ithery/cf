...
class S3File extends File {
     ...
     * @param null|Cacheable $cache
     */
    public function __construct(AwsS3V3Adapter $s3Adapter, string $name = null, Cacheable $cache = null) {
        $this->s3Adapter = $s3Adapter;
        $this->name = $name;
        $this->cache = $cache;
    }

    protected function getS3() : AwsS3V3Adapter {
