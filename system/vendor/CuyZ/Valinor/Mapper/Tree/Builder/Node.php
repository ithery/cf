...
final class Node
{
     ...
     */
    public static function new($value, int $childrenCount = 0): self
    {
        return new self($value,[], $childrenCount);
    }
    ...
    public static function error(Shell $shell, Message $error): self
    {
        ...
        return new self(null, [$nodeMessage]);
    }
    ...
    public function checkUnexpectedKeys(Shell $shell, array $children): self
    {
        ...
        if ($diff !== []) {
            ...
            return new self(
                null,
                array_merge($this->messages, [$nodeMessage])
            );
        }
