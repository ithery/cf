...
final class PhpParser
{
     ...
     */
    public static function parseUseStatements($reflection): array
    {
     ...
     * @return array<string, string>
     */
    private static function fetchUseStatements($reflection): array
    {
    ...
    /**
     * @param ReflectionClass<object>|ReflectionFunction|ReflectionMethod $reflection
     */    private static function getFileContent($reflection): ?string
    {
