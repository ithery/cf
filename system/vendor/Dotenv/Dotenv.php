...
class Dotenv
{
     ...
     */
    public static function create(RepositoryInterface $repository, $paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
     ...
     * @return \Dotenv\Dotenv
     */
    public static function createMutable($paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
     ...
     * @return \Dotenv\Dotenv
     */
    public static function createUnsafeMutable($paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
     ...
     * @return \Dotenv\Dotenv
     */
    public static function createImmutable($paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
     ...
     * @return \Dotenv\Dotenv
     */
    public static function createUnsafeImmutable($paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
        $repository = RepositoryBuilder::createWithDefaultAdapters()
            ->addAdapter(PutenvAdapter::class)
            ->immutable()
     ...
     * @return \Dotenv\Dotenv
     */
    public static function createArrayBacked($paths, $names = null,  $shortCircuit = true,  $fileEncoding = null)
    {
