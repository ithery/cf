...
class Validator
{
    ...
    {
        return $this->assertNullable(
            static function ( $value) use ($regex) {
     ...
     * @return \Dotenv\Validator
     */
    private function assert(callable $callback,  $message)
    {
        $failing = [];
     ...
     * @return \Dotenv\Validator
     */
    private function assertNullable(callable $callback,  $message)
    {
        return $this->assert(
            static function ( $value) use ($callback) {
                if ($value === null) {
                    return true;
                }
