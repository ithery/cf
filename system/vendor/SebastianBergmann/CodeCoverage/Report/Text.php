...
final class Text
{
    ...
    private function coverageColor($numberOfCoveredElements, int $totalNumberOfElements)
    {
    ...
    private function printCoverageCounts($numberOfCoveredElements, int $totalNumberOfElements, int $precision)
    {
        $format = '%' . $precision . 's';
     ...
     */
    private function format($color, int $padding, $string)
    {
