...
final class Totals
{
    ...
    public function setNumLines($loc, int $cloc, int $ncloc, int $executable, int $executed)
    {
    ...
    public function setNumClasses($count, int $tested)
    {
    ...
    public function setNumTraits($count, int $tested)
    {
    ...
    public function setNumMethods($count, int $tested)
    {
    ...
    public function setNumFunctions($count, int $tested)
    {
