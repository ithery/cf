...
final class Facade
{
    ...
    private function processUnit(array $unit, Report $report)
    {
    ...
    private function processFunction(array $function, Report $report)
    {
     ...
     */
    private function documentAsString(DOMDocument $document)
    {
