...
abstract class Renderer
{
    ...
    protected function renderItemTemplate(Template $template, array $data)
    {
        $numSeparator = '&nbsp;/&nbsp;';
    ...
    protected function setCommonTemplateVariables(Template $template, AbstractNode $node)
    {
        $template->setVar(
            [
                'id'               => $node->id(),
    ...
    protected function breadcrumbs(AbstractNode $node)
    {
        $breadcrumbs = '';
    ...
    protected function activeBreadcrumb(AbstractNode $node)
    {
        $buffer = sprintf(
    ...
    protected function inactiveBreadcrumb(AbstractNode $node, $pathToRoot)
    {
        return sprintf(
    ...
    protected function pathToRoot(AbstractNode $node)
    {
        $id    = $node->id();
    ...
    protected function coverageBar(float $percent)
    {
    ...
    protected function colorLevel(float $percent)
    {
    ...
    private function runtimeString()
    {
        $runtime = new Runtime;
