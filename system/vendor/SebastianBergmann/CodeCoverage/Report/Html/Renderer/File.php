...
final class File extends Renderer
{
    ...
    private function renderItems(FileNode $node)
    {
    ...
    private function renderTraitOrClassItems(array $items, Template $template, Template $methodItemTemplate)
    {
        $buffer = '';
    ...
    private function renderFunctionItems(array $functions, Template $template)
    {
        if (empty($functions)) {
            return '';
        }
    ...
    private function renderFunctionOrMethodItem(Template $template, array $item, $indent = '')
    {
        $numMethods       = 0;
        $numTestedMethods = 0;
    ...
    private function renderSourceWithLineCoverage(FileNode $node)
    {
    ...
    private function renderSourceWithBranchCoverage(FileNode $node)
    {
        $linesTemplate      = new Template($this->templatePath . 'lines.html.dist', '{{', '}}');
        $singleLineTemplate = new Template($this->templatePath . 'line.html.dist', '{{', '}}');
    ...
    private function renderSourceWithPathCoverage(FileNode $node)
    {
        $linesTemplate      = new Template($this->templatePath . 'lines.html.dist', '{{', '}}');
        $singleLineTemplate = new Template($this->templatePath . 'line.html.dist', '{{', '}}');
    ...
    private function renderBranchStructure(FileNode $node)
    {
    ...
    private function renderBranchLines(array $branch, array $codeLines, array $testData)
    {
        $linesTemplate      = new Template($this->templatePath . 'lines.html.dist', '{{', '}}');
        $singleLineTemplate = new Template($this->templatePath . 'line.html.dist', '{{', '}}');
    ...
    private function renderPathStructure(FileNode $node)
    {
    ...
    private function renderPathLines(array $path, array $branches, array $codeLines, array $testData)
    {
        $linesTemplate      = new Template($this->templatePath . 'lines.html.dist', '{{', '}}');
        $singleLineTemplate = new Template($this->templatePath . 'line.html.dist', '{{', '}}');
    ...
    private function renderLine(Template $template, int $lineNumber, $lineContent, $class, $popover)
    {
        $template->setVar(
            [
    ...
    private function abbreviateClassName($className)
    {
    ...
    private function abbreviateMethodName($methodName)
    {
    ...
    private function createPopoverContentForTest($test, array $testData)
    {
        $testCSS = '';
    ...
    private function isInlineHtml($token)
    {
        return $token === T_INLINE_HTML;
    }

    private function isKeyword($token)
    {
     ...
     */
    private static function keywordTokens()
    {
