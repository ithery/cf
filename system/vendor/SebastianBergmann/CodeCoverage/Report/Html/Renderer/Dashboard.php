...
final class Dashboard extends Renderer
{
     ...
     */
    private function complexity(array $classes, $baseLink)
    {
        $result = ['class' => [], 'method' => []];
     ...
     */
    private function coverageDistribution(array $classes)
    {
        $result = [
            'class' => [
                '0%'      => 0,
     ...
     */
    private function insufficientCoverage(array $classes, $baseLink)
    {
        $leastTestedClasses = [];
        $leastTestedMethods = [];
        $result             = ['class' => '', 'method' => ''];
     ...
     */
    private function projectRisks(array $classes, $baseLink)
    {
        $classRisks  = [];
        $methodRisks = [];
        $result      = ['class' => '', 'method' => ''];
