...
final class CrapIndex
{
    ...
    public static function fromCyclomaticComplexityAndCoveragePercentage($cyclomaticComplexity, $codeCoverage)
    {
        return new self($cyclomaticComplexity, $codeCoverage);
    }

    public function __construct($cyclomaticComplexity, $codeCoverage)
    {
