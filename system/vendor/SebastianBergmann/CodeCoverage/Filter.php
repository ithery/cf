...
final class Filter
{
    ...
    public function includeDirectory($directory, $suffix = '.php', $prefix = '')
    {
     ...
     */
    public function includeFiles(array $filenames)
    {
    ...
    public function excludeDirectory($directory, $suffix = '.php', $prefix = '')
    {
        foreach ((new FileIteratorFacade)->getFilesAsArray($directory, $suffix, $prefix) as $file) {
