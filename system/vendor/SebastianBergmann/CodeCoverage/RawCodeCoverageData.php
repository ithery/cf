...
final class RawCodeCoverageData
{
    ...
    public static function fromXdebugWithoutPathCoverage(array $rawCoverage)
    {
        return new self($rawCoverage, []);
    }

    public static function fromXdebugWithPathCoverage(array $rawCoverage)
    {
        $lineCoverage     = [];
        $functionCoverage = [];
    ...
    public static function fromXdebugWithMixedCoverage(array $rawCoverage)
    {
        $lineCoverage     = [];
        $functionCoverage = [];
    ...
    public static function fromUncoveredFile($filename, UncoveredFileAnalyser $uncoveredFileAnalyser)
    {
        $lineCoverage = [];
    ...
    public function removeCoverageDataForFile($filename)
    {
     ...
     * @param int[] $lines
     */
    public function keepCoverageDataOnlyForLines($filename, array $lines)
    {
     ...
     * @param int[] $lines
     */
    public function removeCoverageDataForLines($filename, array $lines)
    {
        if (empty($lines)) {
            return;
        }
    ...
    private function getEmptyLinesForFile($filename)
    {
