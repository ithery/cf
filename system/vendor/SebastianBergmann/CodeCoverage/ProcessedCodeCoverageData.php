...
final class ProcessedCodeCoverageData
{
    ...
    public function initializeUnseenData(RawCodeCoverageData $rawData)
    {
    ...
    public function markCodeAsExecutedByTestCase($testCaseId, RawCodeCoverageData $executedCode)
    {
    ...
    public function setLineCoverage(array $lineCoverage)
    {
        $this->lineCoverage = $lineCoverage;
    }

    public function lineCoverage()
    {
    ...
    public function setFunctionCoverage(array $functionCoverage)
    {
        $this->functionCoverage = $functionCoverage;
    }

    public function functionCoverage()
    {
    ...
    public function merge(self $newData)
    {
     ...
     */
    private function priorityForLine(array $data, int $line)
    {
     ...
     */
    private function initPreviouslyUnseenFunction($file, $functionName, array $functionData)
    {
     ...
     */
    private function initPreviouslySeenFunction($file, $functionName, array $functionData)
    {
        foreach ($functionData['branches'] as $branchId => $branchData) {
