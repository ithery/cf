...
final class File extends AbstractNode
{
    ...
    public function __construct($name, AbstractNode $parent, array $lineCoverageData, array $functionCoverageData, array $testData, array $classes, array $traits, array $functions, LinesOfCode $linesOfCode)
    {
    ...
    public function functionCoverageData()
    {
    ...
    public function numberOfExecutableLines()
    {
    ...
    public function numberOfExecutedBranches()
    {
    ...
    public function numberOfExecutedPaths()
    {
        return $this->numExecutedPaths;
    }

    public function numberOfClasses()
    {
    ...
    public function numberOfTestedClasses()
    {
        return $this->numTestedClasses;
    }

    public function numberOfTraits()
    {
    ...
    public function numberOfTestedTraits()
    {
        return $this->numTestedTraits;
    }

    public function numberOfMethods()
    {
    ...
    public function numberOfFunctions()
    {
        return count($this->functions);
    }

    public function numberOfTestedFunctions()
    {
    ...
    private function calculateStatistics(array $classes, array $traits, array $functions)
    {
    ...
    private function processClasses(array $classes)
    {
        $link = $this->id() . '.html#';
    ...
    private function processTraits(array $traits)
    {
        $link = $this->id() . '.html#';
    ...
    private function processFunctions(array $functions)
    {
        $link = $this->id() . '.html#';
    ...
    private function newMethod($className, $methodName, array $method, $link)
    {
        $methodData = [
