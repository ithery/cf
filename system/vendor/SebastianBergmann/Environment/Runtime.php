...
final class Runtime
{
     ...
     */
    public function performsJustInTimeCompilation()
    {
    ...
    public function getNameWithVersionAndCodeCoverageDriver()
    {
     ...
     * @return string[]
     */
    public function getCurrentSettings(array $values)
    {
        $diff  = [];
        $files = [];
    ...
    private function isOpcacheActive()
    {
