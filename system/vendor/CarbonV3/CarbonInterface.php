...
use CarbonV3\Exceptions\ImmutableException;
 ...
 * @method bool            isSameYear(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                                 Checks if the given date is in the same year as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentYear()                                                                                                                                                                                                                               Checks if the instance is in the same year as the current moment.
 * @method bool            isNextYear()                                                                                                                                                                                                                                  Checks if the instance is in the same year as the current moment next year.
 * @method bool            isLastYear()                                                                                                                                                                                                                                  Checks if the instance is in the same year as the current moment last year.
 * @method bool            isSameWeek(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                                 Checks if the given date is in the same week as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentWeek()                                                                                                                                                                                                                               Checks if the instance is in the same week as the current moment.
 * @method bool            isNextWeek()                                                                                                                                                                                                                                  Checks if the instance is in the same week as the current moment next week.
 * @method bool            isLastWeek()                                                                                                                                                                                                                                  Checks if the instance is in the same week as the current moment last week.
 * @method bool            isSameDay(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                                  Checks if the given date is in the same day as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentDay()                                                                                                                                                                                                                                Checks if the instance is in the same day as the current moment.
 * @method bool            isNextDay()                                                                                                                                                                                                                                   Checks if the instance is in the same day as the current moment next day.
 * @method bool            isLastDay()                                                                                                                                                                                                                                   Checks if the instance is in the same day as the current moment last day.
 * @method bool            isSameHour(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                                 Checks if the given date is in the same hour as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentHour()                                                                                                                                                                                                                               Checks if the instance is in the same hour as the current moment.
 * @method bool            isNextHour()                                                                                                                                                                                                                                  Checks if the instance is in the same hour as the current moment next hour.
 * @method bool            isLastHour()                                                                                                                                                                                                                                  Checks if the instance is in the same hour as the current moment last hour.
 * @method bool            isSameMinute(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                               Checks if the given date is in the same minute as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentMinute()                                                                                                                                                                                                                             Checks if the instance is in the same minute as the current moment.
 * @method bool            isNextMinute()                                                                                                                                                                                                                                Checks if the instance is in the same minute as the current moment next minute.
 * @method bool            isLastMinute()                                                                                                                                                                                                                                Checks if the instance is in the same minute as the current moment last minute.
 * @method bool            isSameSecond(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                               Checks if the given date is in the same second as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentSecond()                                                                                                                                                                                                                             Checks if the instance is in the same second as the current moment.
 * @method bool            isNextSecond()                                                                                                                                                                                                                                Checks if the instance is in the same second as the current moment next second.
 * @method bool            isLastSecond()                                                                                                                                                                                                                                Checks if the instance is in the same second as the current moment last second.
 * @method bool            isSameMicro(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                                Checks if the given date is in the same microsecond as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentMicro()                                                                                                                                                                                                                              Checks if the instance is in the same microsecond as the current moment.
 * @method bool            isNextMicro()                                                                                                                                                                                                                                 Checks if the instance is in the same microsecond as the current moment next microsecond.
 * @method bool            isLastMicro()                                                                                                                                                                                                                                 Checks if the instance is in the same microsecond as the current moment last microsecond.
 * @method bool            isSameMicrosecond(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                          Checks if the given date is in the same microsecond as the instance. If null passed, compare to now (with the same timezone).
 ...
 * @method bool            isSameDecade(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                               Checks if the given date is in the same decade as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentDecade()                                                                                                                                                                                                                             Checks if the instance is in the same decade as the current moment.
 * @method bool            isNextDecade()                                                                                                                                                                                                                                Checks if the instance is in the same decade as the current moment next decade.
 * @method bool            isLastDecade()                                                                                                                                                                                                                                Checks if the instance is in the same decade as the current moment last decade.
 * @method bool            isSameCentury(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                              Checks if the given date is in the same century as the instance. If null passed, compare to now (with the same timezone).
 * @method bool            isCurrentCentury()                                                                                                                                                                                                                            Checks if the instance is in the same century as the current moment.
 * @method bool            isNextCentury()                                                                                                                                                                                                                               Checks if the instance is in the same century as the current moment next century.
 * @method bool            isLastCentury()                                                                                                                                                                                                                               Checks if the instance is in the same century as the current moment last century.
 * @method bool            isSameMillennium(null|Carbon|DateTimeInterface|string $date = null)                                                                                                                                                                           Checks if the given date is in the same millennium as the instance. If null passed, compare to now (with the same timezone).
...
interface CarbonInterface extends DateTimeInterface, JsonSerializable {
     ...
     *
     * @return null|string|int|bool|DateTimeZone
     */
     ...
     * (second-precision).
     *
     * @param null|\CarbonV3\Carbon|\DateTimeInterface $date
     *
     * @return static
     */
     ...
     *
     * @param null|Carbon|\DateTimeInterface|string $referenceTime
     * @param array                                 $formats
     *
     * @return string
     */
     ...
     *
     * @param null|Carbon|\CarbonV3\CarbonPeriod|\CarbonV3\CarbonInterval|\DateInterval|\DatePeriod|DateTimeInterface|string $date
     *
     * @return static
     */
     ...
     *
     * @param null|int $value new value for day of year if using as setter
     *
     * @return static|int
     */
     ...
     * current one).
     *
     * @param null|\CarbonV3\CarbonInterface|\DateTimeInterface|string $date
     ...
     * ```
     *
     * @param null|Carbon|\DateTimeInterface|string|array $other   if array passed, will be used as parameters array, see $syntax below;
     ...
     * to indicate the desired dayOfWeek, ex. static::MONDAY.
     *
     * @param null|int $dayOfWeek day of the week default null
     *
     * @return static
     */
     ...
     *
     * @param null|string $context      whole format string
     * @param string      $keySuffix    "", "_short" or "_min"
     * @param null|string $defaultValue default value if translation missing
     *
     * @return string
     */
     ...
     * ```
     *
     * @param null|\CarbonV3\Carbon|\DateTimeInterface $date the instance to compare with or null to use current day
     *
     * @return bool
     */
     ...
     * @param null|\CarbonV3\Carbon|\DateTimeInterface|string $date   instance to compare with or null to use current day
     *
     * @return bool
     */
     ...
     * ```
     *
     * @param null|\CarbonV3\Carbon|\DateTimeInterface $date       the instance to compare with or null to use the current date
     ...
     * ```
     *
     * @param null|\CarbonV3\Carbon|\DateTimeInterface|string $date       the instance to compare with or null to use current day
     * @param bool                                            $ofSameYear check if it is the same month in the same year
     *
     * @return bool
     */
     ...
     * @param null|\CarbonV3\Carbon|\DateTimeInterface $date instance to compare with or null to use current day
     *
     ...
     *
     * @param string      $format
     * @param null|string $originalFormat provide context if a chunk has been passed alone
     *
     * @return string
     */
     ...
     * given.
     *
     * @param null|int $year      if null, act as a getter, if not null, set the year and return current instance
     * @param null|int $dayOfWeek first date of week from 0 (Sunday) to 6 (Saturday)
     * @param null|int $dayOfYear first day of year included in the week #1
     *
     * @return int|static
     */
     ...
     *
     * @param null|int $value new value for weekday if using as setter
     *
     * @return static|int
     */
     ...
     * to indicate the desired dayOfWeek, ex. static::MONDAY.
     *
     * @param null|string|int $modifier
     *
     * @return static
     */
     ...
     *
     * @param null|\DateTimeInterface|Carbon|CarbonImmutable $end      period end date
     * @param null|int|\DateInterval|string                  $interval period default interval or number of the given $unit
     ...
     *
     * @param null|Closure|static|string|false $testNow real or mock Carbon instance
     */
     ...
     *
     * @param null|string|Closure $format
     *
     * @return void
     */
     ...
     * Create a iterable CarbonPeriod object from current date to a given end date (and optional interval).
     *
     * @param null|\DateTimeInterface|Carbon|CarbonImmutable|int $end      period end date or recurrences count if int
     * @param null|int|\DateInterval|string                      $interval period default interval or number of the given $unit
     * @param null|string                                        $unit     if specified, $interval must be an integer
     *
     * @return CarbonPeriod
     ...
     * @param null|string|int|float                                   $number
