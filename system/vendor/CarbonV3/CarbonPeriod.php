...
use CarbonV3\Exceptions\InvalidPeriodDateException;
use CarbonV3\Exceptions\InvalidPeriodParameterException;
use CarbonV3\Exceptions\NotACarbonClassException;
use CarbonV3\Exceptions\NotAPeriodException;
use CarbonV3\Exceptions\UnknownGetterException;
use CarbonV3\Exceptions\UnknownMethodException;
use CarbonV3\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \CarbonV3\Carbon|\CarbonV3\CarbonPeriod|\CarbonV3\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \CarbonV3\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @param \CarbonV3\Carbon|\CarbonV3\CarbonPeriod|\CarbonV3\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \CarbonV3\CarbonInterface
     */
