...
use CarbonV3\Traits\Mixin;
use CarbonV3\Traits\Options;
use CarbonV3\Traits\IntervalStep;
use CarbonV3\Traits\IntervalRounding;
use CarbonV3\Exceptions\ParseErrorException;
use CarbonV3\Exceptions\InvalidCastException;
use CarbonV3\Exceptions\UnknownUnitException;
use CarbonV3\Exceptions\UnknownGetterException;
use CarbonV3\Exceptions\UnknownSetterException;
use CarbonV3\Exceptions\BadFluentSetterException;
use CarbonV3\Exceptions\InvalidIntervalException;
use CarbonV3\Exceptions\UnitNotConfiguredException;
use CarbonV3\Exceptions\BadFluentConstructorException;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface {
     ...
     *
     * @param null|int $years
     * @param null|int $months
     ...
     * @param null|string $interval Input string to convert into an interval
     *
     * @throws \CarbonV3\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval
     *
     * @return static
     */
     ...
     * @param null|string $locale   if locale is null or not specified, current global locale will be used instead
     *
     * @return static
     */
     ...
     *
     * @param null|mixed|int|DateInterval|string|Closure $interval interval or number of the given $unit
     * @param null|string                                $unit     if specified, $interval must be an integer
     *
     * @return null|static
     */
    ...
    public function get($name) {
        ...
        if ($strStartsWithClosure($name, 'total')) {
     ...
     *
     * @param string                             $unit
     * @param null|float|int|string|DateInterval $precision
