...
use CarbonV3\Translator;
use ReturnTypeWillChange;
use CarbonV3\CarbonImmutable;
use CarbonV3\CarbonInterface;
use CarbonV3\Exceptions\OutOfRangeException;
use CarbonV3\Exceptions\InvalidDateException;
...
trait Creator {
     ...
     *
     * @param null|DateTimeInterface|string $time
    ...
    public function __construct($time = null, $tz = null) {
        ...
        $strContains = function_exists('str_contains') ? Closure::fromCallable('str_contains') : function ($haystack, $needle) {
            return $needle !== '' && mb_strpos($haystack, $needle) !== false;
        };

        if (!$strContains((string) .1, '.')) {
     ...
     * @param null|string              $locale if locale is null or not specified, current global locale will be
     *                                         used instead
     * @param null|DateTimeZone|string $tz     optional timezone for the new instance
     *
     * @throws InvalidFormatException
     *
     * @return static
     ...
     * @param string                         $time
     * @param null|DateTimeZone|string|false $originalTz
     *
     ...
     * @param string                         $format Datetime format
     * @param string                         $time
     * @param null|DateTimeZone|string|false $tz
     *
     * @throws InvalidFormatException
     *
     * @return static|false
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null) {
        ...
        /** @var null|\CarbonV3\CarbonImmutable|\CarbonV3\Carbon $mock */
     ...
     * @param string                                             $format     Datetime format
     * @param string                                             $time
     * @param null|DateTimeZone|string|false                     $tz         optional timezone
     * @param null|string                                        $locale     locale to be used for LTS, LT, LL, LLL, etc. macro-formats (en by fault, unneeded if no such macro-format in use)
