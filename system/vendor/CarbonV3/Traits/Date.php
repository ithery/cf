...
trait Date {
     ...
     *
     * @param null|DateTimeZone|string|int $object     original value to get CarbonTimeZone from it
     * @param null|DateTimeZone|string|int $objectDump dump of the object for error messages
     *
     ...
     *
     * @param null|Carbon|DateTimeInterface|string $date
     *
     * @return static
     */
    ...
    public function __call($method, $parameters) {
        ...
        $unit = rtrim($method, 's');
        $strStartsWithClosure = \function_exists('str_starts_with') ? Closure::fromCallable('str_starts_with') : Closure::fromCallable(['cstr', 'startsWith']);
        if ($strStartsWithClosure($unit, 'is')) {
            $word = substr($unit, 2);
        ...
        if (\CarbonV3\Helper::strEndsWith($method, 'Until')) {
            try {
