 ...
 *
 * @property null|int|string $randomKey
 *
 * @method null|int|string randomKey($array = [])
 *
...
class Generator {
     ...
     * @example 48.8932
     *
     * @param null|mixed $nbMaxDecimals
     * @param mixed      $min
     ...
     *
     * @param null|int $nbDigits Defaults to a random number between 1 and 9
