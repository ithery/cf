...
final class ListBlockStartParser implements BlockStartParserInterface, ConfigurationAwareInterface {
    ...
    private function parseList(Cursor $cursor, $inParagraph) {
        ...
        if (\preg_match($this->listMarkerRegex ? $this->listMarkerRegex : $this->generateListMarkerRegex(), $rest) === 1) {
            $data = new ListData();
    ...
    private static function calculateListMarkerPadding(Cursor $cursor, $markerLength) {
    ...
    private function generateListMarkerRegex() {
