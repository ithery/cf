...
abstract class Shapefile {
    ...
    /////////////////////////////// PRIVATE VARIABLES ///////////////////////////////
    /**
     * @var null|int shapefile type
     */
    private $shape_type = null;

    /**
     * @var null|array custom bounding box set with setCustomBoundingBox() method
     */
    private $custom_bounding_box = null;

    /**
     * @var null|array computed bounding box
     */
    private $computed_bounding_box = null;

    /**
     * @var null|string PRJ well-known-text
     */
    private $prj = null;

    /**
     * @var null|string DBF charset
     */
    ...
    /**
     * @var null|bool flag to store whether the machine is big endian or not
     */
