...
class Channel extends Part {
     ...
     * @return Promise
     */
    public function setPermissions(Part $part, array $allow = [], array $deny = []): Promise {
     ...
     * @return Promise
     */
    public function setOverwrite(Part $part, Overwrite $overwrite): Promise {
        if (!$this->is_private) {
     ...
     * @return Promise
     */
    public function moveMember($member): Promise {
        if (!$this->allowVoice()) {
     ...
     * @return Promise
     */
    public function muteMember($member): Promise {
        if (!$this->allowVoice()) {
     ...
     * @return Promise
     */
    public function unmuteMember($member): Promise {
        if (!$this->allowVoice()) {
     ...
     */
    public function createInvite($options = []): Promise {
        if (!$this->is_private) {
            $botperms = $this->guild->members->offsetGet($this->discord->id)->getPermissions($this);
     ...
     * @return Promise
     */
    public function deleteMessages($messages): Promise {
     ...
     * @return Promise
     */
    public function limitDelete(int $value): Promise {
     ...
     */
    public function pinMessage(Message $message): Promise {
        if (!$this->is_private) {
            $botperms = $this->guild->members->offsetGet($this->discord->id)->getPermissions($this);
     ...
     * @return Promise
     */
    public function unpinMessage(Message $message): Promise {
        if (!$this->is_private) {
            $botperms = $this->guild->members->offsetGet($this->discord->id)->getPermissions($this);
     ...
     */
    public function startThread(string $name, bool $private = false, int $auto_archive_duration = 1440): Promise {
     ...
     * @return Promise<Message>
     */
    public function editMessage(Message $message, MessageBuilder $builder): Promise {
