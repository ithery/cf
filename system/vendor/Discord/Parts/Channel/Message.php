...
class Message extends Part {
     ...
     */
    public function startThread(string $name, int $auto_archive_duration = 1440): Promise {
        if (!$this->guild) {
     ...
     */
    public function reply(string $text): Promise {
     ...
     * @return Promise<Message>
     */
    public function delayedReply(string $text, int $delay): Promise {
     ...
     */
    public function delayedDelete(int $delay): Promise {
        $deferred = new Deferred();
