...
class Http {
     ...
     * @return Promise
     */
    public function get($url, $content = null, array $headers = []): Promise {
     ...
     * @return Promise
     */
    public function post($url, $content = null, array $headers = []): Promise {
        if (!($url instanceof Endpoint)) {
            $url = Endpoint::bind($url);
        }
     ...
     * @return Promise
     */
    public function put($url, $content = null, array $headers = []): Promise {
        if (!($url instanceof Endpoint)) {
            $url = Endpoint::bind($url);
        }
     ...
     * @return Promise
     */
    public function patch($url, $content = null, array $headers = []): Promise {
        if (!($url instanceof Endpoint)) {
            $url = Endpoint::bind($url);
        }
     ...
     * @return Promise
     */
    public function delete($url, $content = null, array $headers = []): Promise {
        if (!($url instanceof Endpoint)) {
            $url = Endpoint::bind($url);
        }
     ...
     * @return Promise
     */
    public function queueRequest(string $method, Endpoint $url, $content, array $headers = []): Promise {
     ...
     * @return Promise
     */
    protected function executeRequest(Request $request, Deferred $deferred = null): Promise {
        if ($deferred === null) {
            $deferred = new Deferred();
        }
