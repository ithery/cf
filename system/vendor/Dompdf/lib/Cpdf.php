        ...
        switch ($action) {
            ...
            case 'page':
                if (!is_array($options)) {
                    ...
                    if (isset($options['id'], $options['rid'], $options['pos'])) {
...
EOT;
    ...
    protected function o_fontDescendentCID($id, $action, $options = '') {
        ...
        switch ($action) {
            ...
            case 'out':
                ...
                if (isset($o['info']['fontFileName'], $this->fonts[$o['info']['fontFileName']]['CIDWidths'])) {
     ...
     * @param null|int $rolloverNumObj
     * @param null|int $downNumObj
     */
    ...
    public function getFontHeight($size) {
        ...
        if (isset($font['Ascender'], $font['Descender'])) {
     ...
     */
    public function addEmbeddedFile($filepath, $embeddedFilename, $description) {
        $this->numObj++;
