...
class SSH2
{
     ...
     * @return int|null of bytes as an integer or null for unknown
     */
     ...
     * @param $channel Channel id returned by self::getInteractiveChannelId()
    ...
    {
        while(is_string($data) && strlen($data)) {
