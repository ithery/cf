...
class CFConsole {
    ...
    private static $defaultCommands = [
        ...
        CConsole_Command_Schedule_ScheduleListCommand::class,
        CConsole_Command_Schedule_ScheduleFinishCommand::class,
        CConsole_Command_Schedule_ScheduleRunCommand::class,
        CConsole_Command_Schedule_ScheduleWorkCommand::class,
        CConsole_Command_Schedule_ScheduleTestCommand::class,
