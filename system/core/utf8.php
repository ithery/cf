...
if (!preg_match('/^.$/u', 'ñ')) {
    trigger_error
            ...
            'for more information. This application cannot be run without UTF-8 support.', E_USER_ERROR
    );
}
...
if (!extension_loaded('iconv')) {
    trigger_error
            ...
            'This application cannot be run without UTF-8 support.', E_USER_ERROR
    );
}
