...
<link rel="icon" sizes="{{ c::get(end($config['icons']), 'sizes') }}" href="{{ c::get(end($config['icons']), 'src') }}">

<!-- Add to homescreen for Safari on iOS -->
<meta name="apple-mobile-web-app-capable" content="{{ $config['display'] == 'standalone' ? 'yes' : 'no' }}">
<meta name="apple-mobile-web-app-status-bar-style" content="{{  $config['status_bar'] }}">
<meta name="apple-mobile-web-app-title" content="{{ $config['short_name'] }}">
<link rel="apple-touch-icon" href="{{ c::get(end($config['icons']), 'src') }}">
...
<meta name="msapplication-TileImage" content="{{ c::get(end($config['icons']), 'src') }}">
