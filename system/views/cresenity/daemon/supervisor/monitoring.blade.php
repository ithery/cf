<div id="cf-supervisor-monitoring" x-data="supervisorMonitoring()" x-on:beforeunload="destroyed()">
    <div class="card overflow-hidden">
        ...
        <div x-text="JSON.stringify(ready)"></div>
        <div x-show="!ready" class="d-flex align-items-center justify-content-center card-bg-secondary p-5 bottom-radius">
        ...
        <div x-show="ready && tags.length == 0" class="d-flex flex-column align-items-center justify-content-center card-bg-secondary p-5 bottom-radius">
            <span>You're not monitoring any tags.</span>
        </div>

{{--
        <table x-show="ready && tags.length > 0" class="table table-hover mb-0">
            <thead>
            <tr>
                <th>Tag</th>
