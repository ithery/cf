...
<head>
    ...
    <title><?php echo chtml::specialchars($title) ?></title>

    <style type="text/css">
    html { background: #83c018 url(<?php echo curl::base(false) ?>kohana.png) 50% 0 no-repeat; }
...
<body>
    ...
    <h1><?php echo chtml::specialchars($title) ?></h1>
    <?php echo $content ?>
